...
about-service-workers-title = Ծառայութիւնների աշխատողների մասին
...
scope = <strong>Շրջանակ.</strong> { $name }
script-spec = <strong>Գրվաուածքի հեռանկար.</strong> <a data-l10n-name="link">{ $url }</a>
current-worker-url = <strong>Ընթացիկ աշխատողի URL-ն.</strong> <a data-l10n-name="link">{ $url }</a>
active-cache-name = <strong>Գործուն շտեմարանի անունը.</strong> { $name }
