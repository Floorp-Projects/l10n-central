...
about-debugging-browser-version-too-old-fennec = Firefox-ի այս տարբերակը չի կարող վրիպազերծել Firefox-ը  Android (68)-ի համար: Խորհուրդ է տրուում փորձարկելու համար Ձեր հեռախաւսում տեղադրել Firefox Android Nightly: <a>Լրացուցիչ մանրամասներ</a>
...
about-debugging-worker-inspect-action-disabled =
    .title = Սպասարկիչի ստուգումը ներկայումս անջատուած է բազմագործառութային համար { -brand-shorter-name }֊ի համար։

# Displayed as title of the inspect button for zombie tabs (e.g. tabs loaded via a session restore).
about-debugging-zombie-tab-inspect-action-disabled =
    .title = Ներդիրը ամբողջովին չի բեռնուել եւ չի կարող ստուգուել
