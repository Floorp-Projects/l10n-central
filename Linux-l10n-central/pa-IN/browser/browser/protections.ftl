...
monitor-breaches-unresolved-description = ਲੱਗੀ ਸੰਨ੍ਹ ਦੇ ਵੇਰਵੇ ਵੇਖਣ ਅਤੇ ਆਪਣੀ ਜਾਣਕਾਰੀ ਨੂੰ ਸੁਰੱਖਿਅਤ ਕਰਨ ਲਈ ਕਦਮ ਚੁੱਕਣ ਦੇ ਬਾਅਦ ਤੁਸੀਂ ਸੰਨ੍ਹ ਲਈ ਹੱਲ ਹੋਏ ਦਾ ਨਿਸ਼ਾਨ ਲਾ ਸਕਦੇ ਹੋ।
