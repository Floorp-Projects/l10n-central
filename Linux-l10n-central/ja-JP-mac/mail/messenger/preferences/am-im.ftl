...
chat-encryption-sessions-description = エンドツーエンド暗号化を正しく動作させるため、あなたのアカウントで現在ログインしている他のセッションを信頼しなければなりません。セッションを検証するには他のクライアントと対話する必要があります。一つのセッションを検証することにより、すべてのセッションが信頼され、{ -brand-short-name } による信頼も導かれます。
