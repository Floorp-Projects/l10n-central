...
search-one-offs-context-set-as-default-private =
    .label = プライベートウインドウのデフォルト検索エンジンに設定
    .accesskey = P
...
browser-import-button2 =
    .label = ブックマークを読み込む...
    .tooltiptext = ブックマークを他のブラウザーから { -brand-short-name } に読み込みます。
...
sharing-warning-window = { -brand-short-name } を共有しています。新規タブ に切り替えると、他の人にも見えます。
sharing-warning-screen = 全画面を共有しています。新規タブ に切り替えると、他の人にも見えます。
...
urlbar-result-action-search-in-private-w-engine = プライベートウインドウの { $engine } で検索
# Used when the private browsing engine is the same as the default engine.
urlbar-result-action-search-in-private = プライベートウインドウで検索
# The "with" format was chosen because the search engine name can end with
# "Search", and we would like to avoid strings like "Search MSN Search".
# Variables
#  $engine (String): the name of a search engine
...
toolbar-button-new-private-window =
    .label = 新規プライベートウインドウ
    .tooltiptext = 新規プライベートブラウジングウインドウを開きます ({ $shortcut })
...
navbar-print =
    .label = プリント
    .tooltiptext = このページをプリントします... ({ $shortcut })
