...
fonts-and-colors-header = フォントとカラー
...
applications-description = ウェブからダウンロードしたファイルを { -brand-short-name } が取り扱う方法とブラウズ中に使用するアプリケーションを選んでください。
...
content-blocking-cross-site-cookies-in-all-windows = すべてのウインドウのクロスサイト Cookie (トラッキング Cookie 含む)
