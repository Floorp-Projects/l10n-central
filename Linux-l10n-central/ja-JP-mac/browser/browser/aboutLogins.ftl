...
about-logins-login-intro-heading-logged-out2 = 保存したログイン情報をお探しですか？ 同期をオンにするか、読み込みましょう。
...
about-logins-alert-import-title = 読み込み完了
about-logins-alert-import-message = 読み込み結果を表示
...
about-logins-import-dialog-title = 読み込み完了
about-logins-import-dialog-items-added =
  { $count ->
     *[other] <span>新規ログイン情報の追加:</span> <span data-l10n-name="count">{ $count }</span>
  }
...
about-logins-import-dialog-items-no-change =
  { $count ->
     *[other] <span>ログイン情報の重複:</span> <span data-l10n-name="count">{ $count }</span> <span data-l10n-name="meta">(読み込まれませんでした)</span>
  }
about-logins-import-dialog-items-error =
  { $count ->
      *[other] <span>エラー:</span> <span data-l10n-name="count">{ $count }</span> <span data-l10n-name="meta">(読み込まれませんでした)</span>
  }
about-logins-import-dialog-done = 完了

about-logins-import-dialog-error-title = 読み込みエラー
...
about-logins-import-dialog-error-no-logins-imported = ログイン情報は読み込まれませんでした
about-logins-import-dialog-error-learn-more = 詳細
about-logins-import-dialog-error-try-import-again = 読み込みを再試行...
about-logins-import-dialog-error-cancel = キャンセル

about-logins-import-report-title = 読み込み結果
about-logins-import-report-description = ログイン情報とパスワードが { -brand-short-name } に読み込まれました。
...
about-logins-import-report-row-description-added = 新規ログイン情報を追加しました
...
about-logins-import-report-added =
  { $count ->
      *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">新規ログイン情報の追加</div>
  }
...
about-logins-import-report-no-change =
  { $count ->
      *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">重複</div> <div data-l10n-name="not-imported">(読み込まれませんでした)</div>
  }
about-logins-import-report-error =
  { $count ->
      *[other] <div data-l10n-name="count">{ $count }</div> <div data-l10n-name="details">エラー</div> <div data-l10n-name="not-imported">(読み込まれませんでした)</div>
  }

## Logins import report page

about-logins-import-report-page-title = 読み込み結果の概要
