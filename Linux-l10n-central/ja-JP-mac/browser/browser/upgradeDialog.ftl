...
upgrade-dialog-new-primary-default-button = { -brand-short-name } をデフォルトウェブブラウザーに設定
...
# This title can be explicitly wrapped to control which words are on which line.
upgrade-dialog-default-title-2 = { -brand-short-name } をデフォルトウェブブラウザーに設定
upgrade-dialog-default-subtitle-2 = 高速、安全、プライベートなブラウザーにお任せください。
upgrade-dialog-default-primary-button-2 = デフォルトウェブブラウザーに設定する
