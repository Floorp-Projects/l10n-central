...
perftools-intro-description =
  記録したデータは新規タブの profiler.firefox.com で開きます。データはすべてローカルに保存されますが、アップロードして共有することもできます。
...
perftools-description-intro =
  記録したデータは新規タブの <a>profiler.firefox.com</a> で開きます。データはすべてローカルに保存されますが、アップロードして共有することもできます。
...
perftools-status-private-browsing-notice =
  プライベートブラウジングが有効なときは、プロファイラーは無効になります。プライベートウインドウをすべて閉じてから、再度プロファイラーを有効にしてください。
