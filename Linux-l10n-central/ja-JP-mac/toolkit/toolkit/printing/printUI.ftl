...
printui-save-to-pdf-title = 別名で保存
...
printui-two-sided-printing = 両面プリント
...
printui-system-dialog-link = システムダイアログを使用してプリント...

printui-primary-button = プリント
...
printui-print-progress-indicator = プリント中...
