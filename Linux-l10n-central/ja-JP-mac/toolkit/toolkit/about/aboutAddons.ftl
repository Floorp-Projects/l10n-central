...
detail-private-browsing-label = プライベートウインドウでの実行
# Some add-ons may elect to not run in private windows by setting incognito: not_allowed in the manifest.  This
# cannot be overridden by the user.
detail-private-disallowed-label = プライベートウインドウでは許可されていません
...
detail-private-required-label = プライベートウインドウへのアクセスが必要です
...
private-browsing-description2 =
    ...
    プライベートウインドウでは、{ -brand-short-name } に新たに追加した拡張機能はデフォルトで実行されません。
...
addon-updates-update-addons-automatically = アドオンをデフォルトで自動更新する
    .accesskey = A
...
addon-updates-reset-updates-to-automatic = すべてのアドオンの更新設定をデフォルトにリセット
    .accesskey = R
addon-updates-reset-updates-to-manual = すべてのアドオンの更新設定をデフォルトにリセット
    .accesskey = R
...
pending-uninstall-undo-button = 取り消す
