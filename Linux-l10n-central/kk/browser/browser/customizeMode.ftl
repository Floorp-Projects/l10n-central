...
customize-mode-lwthemes =
    .label = Темалар
customize-mode-overflow-list-description = Элементтерді қолжетімді, бірақ құралдар панелінен тыс ұстау үшін, оларды осында тартып апарыңыз…
customize-mode-uidensity-menu-normal =
    .label = Қалыпты
    .accesskey = л
    .tooltiptext = Қалыпты
customize-mode-uidensity-menu-compact-unsupported =
    .label = Ықшам (қолдауы жоқ)
    .accesskey = ш
    .tooltiptext = Ықшам (қолдауы жоқ)
