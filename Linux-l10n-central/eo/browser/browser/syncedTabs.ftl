...
synced-tabs-sidebar-open-settings = Malfermi agordojn de spegulado
...
synced-tabs-context-sync-now =
    .label = Speguli nun
    .accesskey = S
synced-tabs-fxa-sign-in = Komenci seancon por speguli
synced-tabs-turn-on-sync = Ŝalti speguladon
