...
pp-empty-warning = Viaj konservitaj pasvortoj kaj privataj ŝlosiloj ne estos protektitaj.
pp-erased-ok = Vi forigis la ĉefan pasvorton. { pp-empty-warning }
pp-not-wanted = Averto! Vi decidis ne uzi ĉefan pasvorton. { pp-empty-warning }
...
remove-primary-password-warning1 = Per via ĉefa pasvorto delikataj informoj, kiel legitimiloj kaj pasvortoj, estas protektataj.
remove-primary-password-warning2 = Se vi forigas vian ĉefan pasvorton via informo ne plu estos protektata se via komputilo estas elmetita.
