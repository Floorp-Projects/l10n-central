...
toolbar-context-menu-reload-selected-tab =
    .label = Torne cjarie la schede selezionade
    .accesskey = R
toolbar-context-menu-reload-selected-tabs =
    .label = Torne cjarie lis schedis selezionadis
    .accesskey = R
toolbar-context-menu-bookmark-selected-tab =
    .label = Met tai segnelibris la schede selezionade…
    .accesskey = T
toolbar-context-menu-bookmark-selected-tabs =
    .label = Met tai segnelibris lis schedis selezionadis…
    .accesskey = T
...
toolbar-context-menu-bookmarks-toolbar-never-show-2 =
    .label = No sta mostrâ mai
    .accesskey = N
toolbar-context-menu-bookmarks-toolbar-on-new-tab-2 =
    .label = Mostre dome su gnovis schedis
    .accesskey = o
toolbar-context-menu-bookmarks-show-other-bookmarks =
    .label = Mostre altris segnelibris
    .accesskey = t
toolbar-context-menu-menu-bar-cmd =
    .toolbarname = Sbare dai menù
    .accesskey = m
