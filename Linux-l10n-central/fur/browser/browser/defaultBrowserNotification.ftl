...
default-browser-notification-message = <strong>Meti { -brand-short-name } tant che navigadôr predefinît?</strong> Oten une navigazion svelte, sigure e privade ogni volte che tu dopris il web.
