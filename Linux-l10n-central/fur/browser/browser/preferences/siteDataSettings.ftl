...
site-data-settings-window =
    .title = Gjestìs i cookies e i dâts dal sît
...
site-data-removing-desc = Cu la eliminazion dai cookies e dai dâts dal sît, tu puedis cjatâti disconetût des pagjinis web. Confermistu pardabon lis modifichis?
