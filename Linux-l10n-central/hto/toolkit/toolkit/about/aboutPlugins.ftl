...
file-dd = <span data-l10n-name="file">jónia ráa...</span> { $pluginLibraries }
path-dd = <span data-l10n-name="path">ío</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">Yoga rafue:</span> { $version }
...
state-dd-enabled = <span data-l10n-name="state">Itɨkaɨ:</span> Bónode
