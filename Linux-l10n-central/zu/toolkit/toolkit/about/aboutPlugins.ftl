...
file-dd = <span data-l10n-name="file">Ifayela:</span> { $pluginLibraries }
path-dd = <span data-l10n-name="path">Umzila:</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">Inguqulo:</span> { $version }
