...
about-telemetry-page-title = ٹیلی میٹری ڈاٹا
about-telemetry-general-data-section = جنرل ڈاٹا
about-telemetry-histograms-section = ہسٹو گرام
about-telemetry-keyed-histogram-section = کی وأل ہِسٹوگرام
about-telemetry-simple-measurements-section = سادْ میجرمینٹ
about-telemetry-slow-sql-section = آہستْہ ایس کیو ایل سیٹیٹمینٹ
about-telemetry-addon-details-section = ایڈ۔آن تفصیل
...
about-telemetry-slow-sql-main = آہستْہ ایس کیو ایل سیٹیٹمینٹ مین تھرڈس پیٹھ
about-telemetry-slow-sql-other = آہستْہ ایس کیو ایل سیٹیٹمینٹ ہیلپر تھرڈس پیٹھ
about-telemetry-slow-sql-hits = ہِٹْہ
about-telemetry-slow-sql-average = اوسط ٹایِم (منٹ)
about-telemetry-slow-sql-statement = سیٹیٹمینٹ{ " " }
...
about-telemetry-error-fetching-symbols = اکھ ایرر آو ییلہ سیمبُل فیچ کران أس۔ چک کْریو ذِ توہیہ چھیو کنیکٹِڈ اِنٹرنیٹس پیٹھ تْہ کْریو دوبار کوشش۔
