...
crashed-title = ටැබ් බිදවැටුම් වාර්තාකරු
crashed-close-tab-button = ටැබය වසන්න
crashed-restore-tab-button = මෙම ටැබය යළි පිහිටුවන්න
...
crashed-multiple-offer-help-message = මෙම පිටුව යළි පූරණය කිරිමට { crashed-restore-tab-button } හෝ { crashed-restore-all-button } තෝරන්න.
