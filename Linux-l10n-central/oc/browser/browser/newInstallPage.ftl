...
sync-first = Es lo primièr còp qu’utilizatz { -sync-brand-name } ? Vos cal iniciar una session sus cada installacion de Firefox per sincronizar vòstras informacions.
