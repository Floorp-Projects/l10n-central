...
options-use-sync = אם ברצונך שכל נתוני הפרופיל שלך יהיו זהים בכל ההתקנות של Firefox, ניתן להשתמש ב{ -fxaccount-brand-name(case: "a") } כדי לשמור אותם מסונכרנים.

resources = משאבים:
support-link = שימוש במנהל הפרופילים - מאמר תמיכה

sync-header = התחברות או יצירת { -fxaccount-brand-name(case: "a") }
