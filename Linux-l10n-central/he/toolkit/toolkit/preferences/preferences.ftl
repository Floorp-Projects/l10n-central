...
pp-empty-warning = הססמאות והמפתחות הפרטיים השמורים שלך לא יהיו מוגנים.
pp-erased-ok = מחקת את הססמה הראשית שלך. { pp-empty-warning }
pp-not-wanted = אזהרה! בחרת שלא להשתמש בססמה ראשית. { pp-empty-warning }
