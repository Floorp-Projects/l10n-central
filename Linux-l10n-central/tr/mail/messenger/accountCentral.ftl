...
import-paragraph = { -brand-short-name }, diğer e-posta programlarındaki ve sık kullanılan adres defteri biçimlerindeki posta iletilerini, adres defteri kayıtlarını, besleme aboneliklerini, tercihleri ve/veya süzgeçleri içe aktarmanıza olanak tanır.
