...
policy-NoDefaultBookmarks = Disactivar le creation del marcapaginas predefinite de { -brand-short-name } e del Marcapaginas intelligente (le plus Visitate, etiquettas recente). Nota: iste directiva functiona solmente si usate ante le prime uso del profilo.
