...
screenshot-shortcut =
    .key = S
screenshots-instructions = Потягніть або клацніть на сторінці для вибору області. Натисніть ESC для скасування.
...
screenshots-connection-error-details = Будь ласка, перевірте ваше підключення до Інтернету. Якщо у вас все в порядку з Інтернетом, можливо, виникли тимчасові проблеми зі службою { -screenshots-brand-name }.
