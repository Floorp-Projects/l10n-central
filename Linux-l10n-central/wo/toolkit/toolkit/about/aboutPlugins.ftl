...
file-dd = <span data-l10n-name="file">Dencukaay:</span> { $pluginLibraries }
path-dd = <span data-l10n-name="path">Yoon:</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">Sumb:</span> { $version }
