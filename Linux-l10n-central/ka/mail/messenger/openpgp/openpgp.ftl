...
openpgp-key-man-discover-cmd =
    ...
    .accesskey = ძ
openpgp-key-man-discover-prompt = OpenPGP-გასაღებების ინტერნეტში მოსაძებნად, სერვერზე ან WKD-ოქმის გამოყენებით, შეიყვანეთ ელფოსტის მისამართი ან გასაღების ID.
...
openpgp-key-man-reload =
    .label = განახლება გასაღების კეშის
    .accesskey = ხ
...
openpgp-key-details-sel-action =
    ...
    .accesskey = რ
openpgp-key-details-also-known-label = სავარაუდო სხვა მოწმობები გასაღების მფლობელის:
...
key-personal-warning = თავად შექმენით ეს გასაღები და ნაჩვენები გასაღების მფლობელად თქვენ ხართ მითითებული?
...
expiry-key-expires-soon =
    ...
    სასურველია, შექმნათ ახალი წყვილი გასაღებების და გამართოთ შესაბამისი ანგარიშები მათ გამოსაყენებლად.
expiry-keys-expire-soon =
    მოცემული გასაღებების ვადა ამოიწურება { $days } დღეში:{ $desc }
    სასურველია, შექმნათ ახალი წყვილი გასაღებების და გამართოთ შესაბამისი ანგარიშები მათ გამოსაყენებლად.
expiry-key-missing-owner-trust =
    თქვენს საიდუმლო გასაღებს { $desc } არ აქვს სანდოობა.
    სასურველია, „You rely on certifications“ იყოს „ultimate“ გასაღების თვისებებში.
expiry-keys-missing-owner-trust =
    მოცემულ საიდუმლო გასაღებებს არ აქვს სანდოობა.
    { $desc }.
    სასურველია, „You rely on certifications“ იყოს „ultimate“ გასაღების თვისებებში.
...
no-temp-dir =
    ვერ მოიძებნა დროებითი საქაღალდე ჩასაწერად
    გთხოვთ, დააყენოთ გარემოს ცვლადი TEMP
