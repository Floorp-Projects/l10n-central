...
filelink-description = { -brand-short-name } საშუალებას გაძლევთ გამართოთ მოსახერხებელი ფაილების საცავის ანგარიში, დიდი დანართების გასაგზავნად.
...
import-paragraph = { -brand-short-name } საშუალებას გაძლევთ გადმოიტანოთ ფოსტის წერტილები, წიგნაკის ჩანაწერები, გამოწერილი არხები, პარამეტრები და/ან ფილტრები სხვა საფოსტო პროგრამებიდან და გავრცელებული სახის მისამართების წიგნაკებიდან.
