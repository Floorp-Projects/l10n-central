...
# Variables:
#   $name (String) - the screen name of a chat contact person
state-unverified = მიმდინარე საუბარი დაშიფრულია მაგრამ არა პირადი, ვინაიდან { $name } პირსი ვინაობა ჯერ არაა დამოწმებული.
...
verify-title = პირის ვინაობის დამოწმება
error-title = შეცდომა
success-title = გამჭოლი დაშიფვრა
success-them-title = დაამოწმეთ თქვენი ნაცნობი პირის ვინაობა
fail-title = დამოწმება ვერ ხერხდება
waiting-title = დამოწმების მოთხოვნა გაგზავნილია
