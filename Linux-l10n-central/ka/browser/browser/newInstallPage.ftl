...
changed-desc-profiles = ეს ახლადდაყენებული { -brand-short-name } ახალი პროფილითაა. პროფილი წარმოადგენს ფაილების კრებულს, სადაც Firefox ინახავს ისეთ მონაცემებს, როგორიცაა სანიშნები, პაროლები და მომხმარებლის პარამეტრები.
