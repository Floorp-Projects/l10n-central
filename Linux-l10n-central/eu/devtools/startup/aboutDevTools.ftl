...
newsletter-privacy-label = Ados nago Mozillak nire informazioa erabiltzea <a data-l10n-name="privacy-policy">pribatutasun-politika</a>n adierazten den moduan.
...
features-console-desc = Egin CSS, JavaScript, segurtasun- eta sare-arazoen jarraipena. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-debugger-title = Araztailea
features-debugger-desc = Zure framework-aren euskarria duen JavaScript araztaile ahaltsua. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-network-title = Sarea
features-network-desc = Monitorizatu zure gunea mantsotu edo blokea dezaketen sareko eskaerak. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-storage-title = Biltegiratzea
features-storage-desc = Gehitu, aldatu eta kendu cachea, cookieak, datu-baseak eta saioko datuak. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-responsive-title = Diseinu moldagarriko modua
features-responsive-desc = Probatu guneak emulatutako gailuetan zure nabigatzailetik. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-visual-editing-title = Edizio bisuala
features-visual-editing-desc = Doitu animazioak, lerrokatzea eta betegarriak. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-performance-title = Errendimendua
features-performance-desc = Desblokeatu buxadurak, sinplifikatu prozesuak, optimizatu baliabideak. <a data-l10n-name="learn-more">{ features-learn-more }</a>
