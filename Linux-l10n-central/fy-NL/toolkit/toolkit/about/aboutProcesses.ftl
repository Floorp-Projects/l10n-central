...
about-processes-web-large-allocation-process = { $origin } ({ $pid }, grut)
...
about-processes-web-large-allocation-process-private = { $origin } – Privee ({ $pid }, grut)
...
about-processes-cpu-idle = ynaktyf
    .title = Totale CPU-tiid: { NUMBER($total, maximumFractionDigits: 2) }{ $unit }
