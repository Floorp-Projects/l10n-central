...
is-default = Floorp for Linux does not allow you to configure the default browser from within.
Linux = learn more
is-linux = Floorp for Linux does not allow you to configure the default browser from Floorp
is-not-default = Floorp for Linux does not allow you to configure the default browser from within.
