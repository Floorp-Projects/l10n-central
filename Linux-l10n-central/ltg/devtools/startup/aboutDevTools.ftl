...
head-title = Par izstrōdōtōju reikim
enable-title = Īslēgt izstrōdōtōju reikus
enable-inspect-element-title = Īslēgt izstrōdōtōju reikus kab porbaudēt elementu
...
features-network-desc = Porraugi teikla pīprasejumus, kas par palānynōt voi bloķēt tovu lopu. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-storage-title = Krōtuve
features-storage-desc = Pīvīnoj, maini un nūjam cache, seikdatnes, datubāzes un seseju datus. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-responsive-title = Adaptivō dizaina režims
features-responsive-desc = Porbaudi lopys uz vysaidom īreicam nu porlyuka. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-visual-editing-title = Vizuala rediģiešona
features-visual-editing-desc = Pīsleipej animecejis, leidzynōšonu un atstarpes. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-performance-title = Veiktspieja
features-performance-desc = Atrūn švakōs vītys, optimizej procesus un lopys resursus. <a data-l10n-name="learn-more">{ features-learn-more }</a>
