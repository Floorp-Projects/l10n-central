...
safeb-blocked-unwanted-page-title = Itymā lopā var byut kvuorobainys programys
safeb-blocked-harmful-page-title = Itymā lopā var byut kvuorobainys programys
...
safeb-palm-advisory-desc = Īteikumus nūdrūsynoj <a data-l10n-name='advisory_provider'>{ $advisoryname }</a>.
safeb-palm-accept-label = Īt atpakaļ
safeb-palm-see-details-label = Seikuoka informaceja
...
safeb-blocked-harmful-page-learn-more = Uzzinit vairuok par { -brand-short-name } beistamuos programaturys aizsardzeibu <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
