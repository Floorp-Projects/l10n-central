...
crashed-single-offer-help-message = Veldu { crashed-restore-tab-button } til að endurhlaða síðu.
crashed-multiple-offer-help-message = Veldu { crashed-restore-tab-button } eða { crashed-restore-all-button } til að endurhlaða síðu.
