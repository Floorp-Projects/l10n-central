...
downloading-file-opens-in-hours-and-minutes = Åpner om { $hours }t { $minutes }m…
downloading-file-opens-in-minutes = Åpner om { $minutes }m…
downloading-file-opens-in-minutes-and-seconds = Åpner om { $minutes }m { $seconds }s…
downloading-file-opens-in-seconds = Åpner om { $seconds }s…
downloading-file-opens-in-some-time = Åpner om når det er klart…
