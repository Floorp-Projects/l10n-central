...
policy-DisableBuiltinPDFViewer = Zastawianie PDF.js (wbudowanyj przeglōndarki PDFōw we aplikacyji { -brand-short-name }).

policy-DisableDefaultBrowserAgent = Zakazowanie agyntowi bazowyj przeglōndarki kludzynio żodnych akcyji. Tyko sie ino Windowsa; tego agynta niy ma w inkszych systymach.
...
policy-LegacySameSiteCookieBehaviorEnabledForDomainList = Nostowio przedowniōne zachowanie SameSite do cookies na ôbkryślonych strōnach.
