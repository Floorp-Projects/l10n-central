...
pp-empty-warning = Tes pleds-clav memorisads e tias clavs privatas na vegnan betg protegids.
pp-erased-ok = Ti has stizzà tes pled-clav universal. { pp-empty-warning }
pp-not-wanted = Attenziun! Ti has decidì da betg utilisar in pled-clav universal. { pp-empty-warning }
