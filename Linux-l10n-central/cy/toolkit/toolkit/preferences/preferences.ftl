...
pp-empty-warning = Fydd eich cyfrineiriau a'ch allweddi preifat wedi'u storio ddim yn cael eu gwarchod.
pp-erased-ok = Rydych wedi dileu eich Prif Gyfrinair.  { pp-empty-warning }
pp-not-wanted = Rhybudd! Rydych wedi penderfynu peidio â defnyddio Prif Gyfrinair. { pp-empty-warning }
