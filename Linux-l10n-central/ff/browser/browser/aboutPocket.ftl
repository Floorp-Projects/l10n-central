...
pocket-panel-saved-error-not-saved = Hello Danndaaka
pocket-panel-saved-page-removed = Hello Momtaama
pocket-panel-saved-page-saved = Danndaama to { -pocket-brand-name }
pocket-panel-saved-processing-remove = Nana Momta Hello…
pocket-panel-saved-processing-tags = Nana ɓeyda tage…
pocket-panel-saved-remove-page = Momtu Hello
pocket-panel-saved-save-tags = Danndu
...
pocket-panel-signup-already-have = Aɗa huutoroo { -pocket-brand-name } kisa?
pocket-panel-signup-learn-more = Ɓeydi Humpito
pocket-panel-signup-login = Seŋo
