...
pkcs12-unknown-err-backup = Horiima sosde fiilde restorde PKCS #12 ndee sabu daliilu mo anndaaka.
pkcs12-unknown-err = Gollal e dow PKCS #12 woorii sabu daliilu mo anndaaka.
pkcs12-info-no-smartcard-backup = Danndude seedamfaaje ummiinde e kaɓirgol kisal hono kartal timmital wonataa.
pkcs12-dup-data = Seedamfaagu nguu e kelal suturo ngoo ena ngoodi kisa e ngol kaɓirgol kisal.

## PKCS#12 file dialogs

choose-p12-backup-file-dialog = Innde Fiilde Restorteende
file-browse-pkcs12-spec = Piille PKCS12
choose-p12-restore-file-dialog = Fiilde Seedamfaagu Jiggeteede
