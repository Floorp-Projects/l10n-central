...
about-private-browsing-info-myths = ความเข้าใจผิดที่พบบ่อยเกี่ยวกับการเรียกดูแบบส่วนตัว
...
about-private-browsing-info-description = { -brand-short-name } จะล้างประวัติการค้นหาและประวัตการเรียกดูของคุณเมื่อคุณออกจากแอปหรือปิดแท็บและหน้าต่างการเรียกดูแบบส่วนตัวทั้งหมด แม้ว่าสิ่งนี้จะไม่ทำให้คุณปิดบังตัวตนกับเว็บไซต์หรือผู้ให้บริการอินเทอร์เน็ตของคุณ แต่จะทำให้การรักษาความเป็นส่วนตัวของสิ่งที่คุณทำออนไลน์จากผู้อื่นที่ใช้คอมพิวเตอร์เครื่องนี้ง่ายขึ้น
