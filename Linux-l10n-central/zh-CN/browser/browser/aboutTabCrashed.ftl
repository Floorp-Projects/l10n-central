...
crashed-send-report-2 = 自动发送一份崩溃报告以帮助我们修复此类问题。
crashed-comment =
    .placeholder = 加上附注（选填且公开可见）
crashed-include-URL-2 = 包含 { -brand-short-name } 崩溃时您访问的网址
crashed-report-sent = 崩溃报告已提交。感谢您帮助 { -brand-short-name } 变得更好！
crashed-request-auto-submit-title = 反馈后台标签页
crashed-auto-submit-checkbox-2 = 更新首选项为 { -brand-short-name } 崩溃时自动提交报告
