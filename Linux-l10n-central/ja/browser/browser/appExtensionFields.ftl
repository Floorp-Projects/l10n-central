...
extension-default-theme-name-auto = Linux GTK テーマ (破損する可能性あり)
...
extension-firefox-compact-dark-name = ダークテーマ（デフォルト）
...
extension-floorp-lepton-name =水平タブ位置移動（デザインはシステムに追従します）
extension-floorp-lepton-description = 水平タブの位置を、ブックマークバーの下に移動します。
extension-floorp-edge-name=垂直タブに Floorp を最適化（デザインはシステムに追従します）
