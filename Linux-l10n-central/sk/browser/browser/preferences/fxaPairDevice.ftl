...
fxa-qrcode-heading-step3 = 3. Otvorte <b>ponuku</b> (<img data-l10n-name="ios-menu-icon"/> alebo <img data-l10n-name="android-menu-icon"/>), ťuknite na <img data-l10n-name="settings-icon"/> <b>Nastavenia</b> a zvoľte položku <b>Zapnúť synchronizáciu</b>.
