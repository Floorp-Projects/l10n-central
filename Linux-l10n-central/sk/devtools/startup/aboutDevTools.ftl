...
enable-about-debugging-message = Pomocou vývojárskych nástrojov môžete vo Firefoxe vyvíjať a ladiť doplnky typu WebExtensions, webové skripty, skripty typu worker a ďalšie.
...
features-responsive-title = Režim Responzívny dizajn
