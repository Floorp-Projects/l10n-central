...
add-exception-domain-mismatch-long = సర్టిఫికేట్ ఎవరైనా ఈ సైట్ అనుకరించడానికి ప్రయత్నిస్తున్నారు ఆ అర్ధం కాలేదు వేరే సైట్, చెందుతుంది.
add-exception-expired-short = పాతబడిన సమాచారం
add-exception-expired-long = సర్టిఫికేట్ ప్రస్తుతం చెల్లుబాటు కాదు. ఇది దోచుకున్న ఉండవచ్చు లేదా కోల్పోయింది, మరియు ఈ సైట్ అనుకరించడానికి ఎవరైనా ఉపయోగించవచ్చు.
