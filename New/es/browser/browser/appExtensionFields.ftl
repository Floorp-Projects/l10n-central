...
extension-Floorp-compact-light-name = Claro
extension-Floorp-compact-light-description = Un tema con una paleta de colores claros.
extension-Floorp-compact-dark-name = Oscuro
extension-Floorp-compact-dark-description = Un tema con una paleta de colores oscuro.
extension-Floorp-alpenglow-name = Floorp Alpenglow
extension-Floorp-alpenglow-description = Usar una apariencia colorida para botones, menús y ventanas.
