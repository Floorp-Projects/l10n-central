...
fxa-qrcode-heading-step1 = 1. Instale o <a data-l10n-name="connect-another-device">Floorp em seu dispositivo móvel</a>, se ainda não instalou.

fxa-qrcode-heading-step2 = 2. Abra o Floorp em seu dispositivo móvel.
