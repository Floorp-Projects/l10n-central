...
about-debugging-this-Floorp-runtime-name = Este { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = Usar <a>{ about-debugging-this-Floorp-runtime-name }</a> para depurar extensões e service workers nesta versão do { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Ativar depuração USB no Floorp no dispositivo Android.
...
about-debugging-browser-version-too-old-fennec = Esta versão do Floorp não pode depurar o Floorp para Android (68). Recomendamos instalar o Floorp para Android Nightly em seu celular para testes. <a>Mais detalhes</a>
...
about-debugging-browser-version-too-recent = O navegador conectado é mais recente ({ $runtimeVersion }, buildID { $runtimeID }) do que seu { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Esta é uma configuração não suportada e pode causar falhas no DevTools. Atualize o Floorp. <a>Soluções de problemas</a>
