...
extension-Floorp-compact-light-description = 明るい配色のテーマです。
extension-Floorp-compact-dark-name = Dark
extension-Floorp-compact-dark-description = 暗い配色のテーマです。
extension-Floorp-alpenglow-name = Floorp Alpenglow
extension-Floorp-alpenglow-description = カラフルな外観のボタン、メニュー、ウィンドウを使用します。
