...
safeb-blocked-malware-page-learn-more-sumo = Więcej informacji o ochronie przed złośliwym oprogramowaniem i próbami oszustwa przeglądarki { -brand-short-name } można znaleźć w witrynie <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Więcej informacji o ochronie przed złośliwym oprogramowaniem i próbami oszustwa przeglądarki { -brand-short-name } można znaleźć w witrynie <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
