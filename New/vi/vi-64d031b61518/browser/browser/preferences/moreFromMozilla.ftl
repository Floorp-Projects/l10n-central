...
more-from-moz-Floorp-mobile-title = { -brand-product-name } dành cho di động
more-from-moz-Floorp-mobile-description = Trình duyệt di động đặt quyền riêng tư của bạn lên hàng đầu.
more-from-moz-Floorp-mobile-description-advanced = Từ việc chặn trình theo dõi đến giải quyết các vấn đề phiền toái khi tự động phát, trình duyệt { -brand-product-name } trên điện thoại di động làm việc ngoài giờ để đảm bảo bạn đang sử dụng Internet tốt.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Tải xuống bằng thiết bị di động của bạn. Hướng máy ảnh của bạn vào mã QR. Khi một liên kết xuất hiện, hãy nhấn vào nó.
more-from-moz-qr-code-box-Floorp-mobile-button = Gửi email đến điện thoại của bạn để thay thế
