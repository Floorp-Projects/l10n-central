...
enable-title = Kích hoạt công cụ dành cho nhà phát triển Floorp
enable-inspect-element-title = Bật công cụ dành cho nhà phát triển Floorp để sử dụng kiểm tra phần tử
...
enable-about-debugging-message = Phát triển và gỡ lỗi WebExtensions, web workers, service worker và nhiều hơn nữa với công cụ dành cho nhà phát triển Floorp.
...
enable-common-message = Công cụ dành cho nhà phát triển Floorp bị tắt theo mặc định để cung cấp cho bạn quyền kiểm soát nhiều hơn đối với trình duyệt của bạn.
...
welcome-title = Chào mừng đến với công cụ dành cho nhà phát triển Floorp!
...
footer-title = Phiên bản Floorp cho nhà phát triển
footer-message = Muốn tìm kiếm nhiều thứ hơn về công cụ dành cho nhà phát triển? Hãy xem trình duyệt Floorp được xây dựng dành riêng cho các nhà phát triển và quy trình làm việc hiện đại.
