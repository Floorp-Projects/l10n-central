...
enable-about-debugging-message = S nástrojích pro vývojáře můžete v prohlížeči Floorp vyvíjet a ladit WebExtensions, web a service workers a další.
...
enable-common-message = Nástroje pro vývojáře jsou ve výchozím stavu prohlížeče Floorp vypnuty pro vaši větší kontrolu nad jeho funkcemi.
...
footer-message = Hledáte více než jenom nástroje pro vývojáře? Vyzkoušejte verzi prohlížeče Floorp speciálně pro vývojáře a jejich pracovní postupy.
