...
safeb-blocked-phishing-page-learn-more = 到 <a data-l10n-name='learn_more_link'>www.antiphishing.org</a> 可以详细了解诈骗网站和钓鱼。到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 可以详细了解 { -brand-short-name } 防范钓鱼和恶意软件的机制。
...
safeb-blocked-malware-page-learn-more-sumo = 访问 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 详细了解 { -brand-short-name } 的钓鱼网站与恶意网站防护功能。
...
safeb-blocked-unwanted-page-learn-more = 查阅 <a data-l10n-name='learn_more_link'>流氓软件政策</a> 可以详细了解有害和流氓的软件。到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 可以详细了解 { -brand-short-name } 防范钓鱼和恶意软件的机制。
...
safeb-blocked-harmful-page-learn-more = 访问 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 详细了解 { -brand-short-name } 的钓鱼网站与恶意网站防护功能。
