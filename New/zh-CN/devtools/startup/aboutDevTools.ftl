...
head-title = 关于开发者工具
enable-title = 启用 Floorp 开发者工具
enable-inspect-element-title = 启用 Floorp 开发者工具以使用元素探查器
enable-inspect-element-message = 用开发者工具的探查器来检查和编辑 HTML 和 CSS。
enable-about-debugging-message = 开发和调试 WebExtensions、Web worker、Service worker，……，尽在 Floorp 开发者工具。
...
footer-title = Floorp 开发者版本
footer-message = 开发者工具不够尽兴？探索专为开发者和现代工作流程打造的 Floorp 浏览器。
