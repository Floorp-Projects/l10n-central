...
fxa-qrcode-heading-step1 = 1. Установите <a data-l10n-name="connect-another-device">Floorp на ваше мобильное устройство</a>, если вы ещё этого не сделали.

fxa-qrcode-heading-step2 = 2. Откройте Floorp на вашем мобильном устройстве.
