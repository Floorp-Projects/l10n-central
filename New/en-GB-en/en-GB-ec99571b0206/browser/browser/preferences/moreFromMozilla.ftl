...
more-from-moz-Floorp-mobile-title = { -brand-product-name } Mobile
more-from-moz-Floorp-mobile-description = The mobile browser that puts your privacy first.
more-from-moz-Floorp-mobile-description-advanced = From blocking trackers to putting the brakes on autoplay annoyances, { -brand-product-name } mobile browsers work overtime to make sure you’re getting the good internet.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Download using your mobile device. Point your camera at the QR code. When a link appears, tap it.
more-from-moz-qr-code-box-Floorp-mobile-button = Send an email to your phone instead
