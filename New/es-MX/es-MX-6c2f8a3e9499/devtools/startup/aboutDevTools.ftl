...
enable-title = Habilitar herramientas de Floorp Developer
enable-inspect-element-title = Habilitar las herramientas de desarrollador de Floorp para usar Inspeccionar elemento
enable-inspect-element-message = Examinar y editar HTML y CSS para el inspector de herramientas de desarrollador.
enable-about-debugging-message = Desarrollar y depurar WebExtensions, web workers, service workers y más con las herramientas de desarrollador de Floorp.
...
welcome-title = ¡Bienvenido a las herramientas de desarrollador de Floorp!
...
footer-message = ¿Buscas más que unas simples herramientas de desarrollador? Revisa el navegador Floorp que está creado específicamente por desarrolladores y flujos de trabajo modernos.
