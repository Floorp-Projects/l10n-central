...
perftools-intro-description =
    Las grabaciones abren profiler.Floorp.com en una nueva pestaña. Todos los datos se almacenan 
...
perftools-description-intro =
    Las grabaciones abren <a>profiler.Floorp.com</a> en una nueva pestaña. Todos los datos son almacenados
...
perftools-presets-Floorp-description = Configuración preestablecida recomendada para crear perfiles de { -brand-shorter-name }.
