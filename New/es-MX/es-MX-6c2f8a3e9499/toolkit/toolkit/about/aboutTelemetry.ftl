...
about-telemetry-Floorp-data-doc = La <a data-l10n-name="data-doc-link">documentación de datos de Floorp</a> contiene guías sobre cómo trabajar con tus herramientas de datos.
about-telemetry-telemetry-client-doc = La <a data-l10n-name="client-doc-link">documentación de cliente de Floorp Telemetry</a> incluye definiciones para conceptos, documentación de API y referencias de datos.
...
about-telemetry-show-in-Floorp-json-viewer = Abrir en el visor de JSON
