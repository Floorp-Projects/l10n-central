...
policy-DisableFloorpAccounts = Deshabilitar los servicios basados en { -fxaccount-brand-name }, incluido Sync.

# Floorp Screenshots is the name of the feature, and should not be translated.
policy-DisableFloorpScreenshots = Deshabilitar la función de Floorp Screenshots.
...
policy-FloorpHome = Configura Floorp Home.
