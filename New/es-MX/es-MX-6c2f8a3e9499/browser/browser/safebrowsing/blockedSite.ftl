...
safeb-blocked-phishing-page-learn-more = Conoce más sobre sitios peligrosos y phishing en <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Conoce más acerca de la protección contra malware y phishing que ofrece { -brand-short-name } en <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Aprende más sobre la protección de phishing y malware de { -brand-short-name } en <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Conoce más acerca de la protección contra Phishing y Malware que ofrece { -brand-short-name } en <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
