...
about-debugging-setup-this-Floorp2 = Utilize <a>{ about-debugging-this-Floorp-runtime-name }</a> para depurar extensões e service workers nesta versão do { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Ative a depuração USB no Floorp no dispositivo Android.
...
about-debugging-browser-version-too-old-fennec = Esta versão do Floorp não pode depurar o Floorp para Android (68). Nós recomendamos a instalação do Floorp Nightly para Android no seu telefone para fazer testes. <a>Mais detalhes</a>
