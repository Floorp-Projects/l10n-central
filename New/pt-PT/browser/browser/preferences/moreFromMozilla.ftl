...
more-from-moz-Floorp-mobile-title = { -brand-product-name } Móvel
more-from-moz-Floorp-mobile-description = O navegador móvel que coloca a sua privacidade em primeiro lugar.
more-from-moz-Floorp-mobile-description-advanced = Desde bloquear rastreadores até travar o problema da reprodução automática, os navegadores móveis { -brand-product-name } trabalham horas extras para garantir que tenha o bom da internet.
...
more-from-moz-button-mozilla-rally =
    .label = Junte-se a { -rally-short-name }
more-from-moz-qr-code-box-Floorp-mobile-title = Transfira utilizando o seu dispositivo móvel. Aponte a sua câmara para o código QR. Quando uma ligação aparecer, toque nela.
more-from-moz-qr-code-box-Floorp-mobile-button = Envie um e-mail para o seu telemóvel em vez disso
