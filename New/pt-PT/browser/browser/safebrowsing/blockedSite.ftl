...
safeb-blocked-phishing-page-learn-more = Saiba mais acerca de sites decetivos e phishing em <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Saiba mais acerca da proteção contra phishing e malware do { -brand-short-name } em <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Saiba mais sobre a proteção contra phishing e malware do { -brand-short-name } em <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Saiba mais acerca da proteção contra phishing e malware do { -brand-short-name } em <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
