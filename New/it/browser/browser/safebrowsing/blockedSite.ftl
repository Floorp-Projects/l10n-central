...
safeb-blocked-phishing-page-learn-more = Scopri ulteriori informazioni relative a siti ingannevoli e phishing sul sito <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Per approfondimenti sulla protezione da phishing e malware di { -brand-short-name } visita <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Ulteriori informazioni relative alla protezione da phishing e malware di { -brand-short-name } sono disponibili su <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Scopri ulteriori informazioni relative a software dannoso e indesiderato nella pagina <a data-l10n-name='learn_more_link'>Norme relative al software indesiderato</a>. Per approfondimenti sulla protezione da phishing e malware di { -brand-short-name } visita <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Per ulteriori informazioni sulla protezione da phishing e malware di { -brand-short-name } visita <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
