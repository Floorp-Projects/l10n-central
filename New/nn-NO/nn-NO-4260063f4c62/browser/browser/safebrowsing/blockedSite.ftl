...
safeb-blocked-phishing-page-learn-more = Les meir om villeiande nettstadar og nettfisking på <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Les meir om { -brand-short-name } sitt vern mot nettfisking og skadeleg programvare på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Les meir om{ -brand-short-name } sitt vern mot nettfiske og skadeleg programvare på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Les meir om skadeleg og uønskt programvare på <a data-l10n-name='learn_more_link'>Uønskt programvarepraksis</a>. Les meir om { -brand-short-name } sitt vern mot nettfisking og skadeleg programvare på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Les meir om { -brand-short-name } sitt vern mot nettfisking og skadeleg programvare på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
