...
safeb-blocked-phishing-page-learn-more = 請到 <a data-l10n-name='learn_more_link'>www.antiphishing.org</a> 了解關於釣魚與詐騙網站的更多資訊。也可以到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 了解關於 { -brand-short-name } 的防釣魚及惡意軟體保護機制的更多資訊。
...
safeb-blocked-malware-page-learn-more-sumo = 請到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 了解關於 { -brand-short-name } 的防釣魚及惡意軟體保護機制的更多資訊。
...
safeb-blocked-unwanted-page-learn-more = 請到 <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a> 了解關於有害及惹人厭惡的軟體的更多資訊。也可以到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 了解關於 { -brand-short-name } 的防釣魚及惡意軟體保護機制的更多資訊。
...
safeb-blocked-harmful-page-learn-more = 請到 <a data-l10n-name='Floorp_support'>support.mozilla.org</a> 了解關於 { -brand-short-name } 的防釣魚及惡意軟體保護機制的更多資訊。
