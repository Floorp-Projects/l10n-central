...
profiler-popup-presets-web-developer-label =
    .label = 網頁開發者
profiler-popup-presets-Floorp-platform-description = 推薦於 Floorp 內部平台除錯時使用。
profiler-popup-presets-Floorp-platform-label =
    .label = Floorp 平台
profiler-popup-presets-Floorp-front-end-description = 推薦於 Floorp 內部前端介面除錯時使用。
profiler-popup-presets-Floorp-front-end-label =
    .label = Floorp 前端
profiler-popup-presets-Floorp-graphics-description = 推薦於檢查 Floorp 圖形效能問題時使用。
profiler-popup-presets-Floorp-graphics-label =
    .label = Floorp 圖形
profiler-popup-presets-media-description = 推薦於診斷 Floorp 影音問題時使用。
profiler-popup-presets-Floorp-description = 對 { -brand-shorter-name } 進行效能檢測的建議預設值。
