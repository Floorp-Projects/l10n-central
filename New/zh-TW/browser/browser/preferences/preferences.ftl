...
home-prefs-content-header = Floorp 首頁內容
home-prefs-content-description = 選擇要在您的 Floorp 首頁顯示哪些內容。
...
sync-mobile-promo = 下載 Floorp for<img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a>或<img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a>以與您的行動裝置同步。
...
sync-engine-addons =
    .label = 附加元件
    .tooltiptext = Floorp 桌機版的擴充套件與佈景主題
    .accesskey = A
