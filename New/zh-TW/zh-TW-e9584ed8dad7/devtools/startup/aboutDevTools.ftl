...
head-title = 關於開發者工具
enable-title = 啟用 Floorp 開發者工具
enable-inspect-element-title = 啟用 Floorp 開發者工具來檢測頁面元素
enable-inspect-element-message = 使用開發者工具的檢測器來檢測和編輯 HTML 和 CSS。
enable-about-debugging-message = 使用 Floorp 開發者工具開發，並對 WebExtensions、Web Worker、Service Worker 除錯。
...
footer-message = 想要的不只是開發者工具嗎？快試試特地為了開發者與現代工作流程所打造的 Floorp 瀏覽器。
...
welcome-message = 您已成功開啟開發者工具！要開始使用，請試試網頁開發者選單，或是使用 { $shortcut } 開啟工具。
