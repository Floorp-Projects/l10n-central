...
safeb-blocked-malware-page-learn-more-sumo = Pelajari lebih lanjut tentang Perlindungan Pengelabuan dan Perangkat Perusak dari { -brand-short-name } di <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Pelajari lebih lanjut tentang Perlindungan Pengelabuan dan Perangkat Perusak dari { -brand-short-name } di <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
