...
about-debugging-this-Floorp-runtime-name = { -brand-shorter-name } ini
...
about-debugging-setup-this-Floorp2 = Gunakan <a>{ about-debugging-this-Floorp-runtime-name }</a> untuk debugging ekstensi dan service worker di versi { -brand-shorter-name } ini.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Aktifkan Debugging USB di Floorp pada perangkat Android.
...
about-debugging-browser-version-too-old-fennec = Versi Floorp ini tidak dapat melakukan debug Floorp untuk Android (68). Kami sarankan untuk menginstal Floorp untuk Android Nightly di ponsel anda untuk pengujian. <a>Detail lebih lanjut</a>
