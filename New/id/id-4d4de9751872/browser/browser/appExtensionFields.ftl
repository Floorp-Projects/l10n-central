...
extension-Floorp-compact-light-name = Terang
extension-Floorp-compact-light-description = Tema dengan skema warna terang.
extension-Floorp-compact-dark-name = Gelap
extension-Floorp-compact-dark-description = Tema dengan skema warna gelap.
extension-Floorp-alpenglow-name = Floorp Alpenglow
extension-Floorp-alpenglow-description = Gunakan tampilan berwarna untuk tombol, menu, dan jendela.
