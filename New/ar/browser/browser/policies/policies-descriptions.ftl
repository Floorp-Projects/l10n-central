...
policy-DisableFloorpAccounts = تعطيل الخدمات التي تعتمد { -fxaccount-brand-name }، بما في ذلك المزامنة.
# Floorp Screenshots is the name of the feature, and should not be translated.
policy-DisableFloorpScreenshots = تعطيل ميزة لقطات شاشة Floorp.
policy-DisableFloorpStudies = منع { -brand-short-name } من تشغيل الدارسات.
...
policy-FloorpHome = ضبط صفحة المنزل داخل Floorp.
