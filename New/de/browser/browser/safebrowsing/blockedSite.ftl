...
safeb-blocked-malware-page-learn-more-sumo = Weitere Informationen zum Schutz vor Betrug und Schadsoftware in { -brand-short-name } stehen unter <a data-l10n-name='Floorp_support'>support.mozilla.org</a> bereit.
...
safeb-blocked-harmful-page-learn-more = Weitere Informationen zum Schutz vor Betrug und Schadsoftware in { -brand-short-name } stehen unter <a data-l10n-name='Floorp_support'>support.mozilla.org</a> bereit.
