...
more-from-moz-Floorp-mobile-title = { -brand-product-name } für Mobilgeräte
more-from-moz-Floorp-mobile-description = Der mobile Browser, für den Ihre Privatsphäre an erster Stelle steht.
more-from-moz-Floorp-mobile-description-advanced = Von der Blockierung von Trackern bis hin zur Bremse für nervige automatische Wiedergabe arbeiten die mobilen Browser von { -brand-product-name } Überstunden, um sicherzustellen, dass Sie das gute Internet kriegen.
...
more-from-moz-button-mozilla-rally =
    .label = Bei { -rally-short-name } mitmachen
more-from-moz-qr-code-box-Floorp-mobile-title = Laden Sie es mit Ihrem Mobilgerät herunter. Richten Sie Ihre Kamera auf den QR-Code. Wenn ein Link angezeigt wird, tippen Sie darauf.
more-from-moz-qr-code-box-Floorp-mobile-button = Stattdessen eine E-Mail an Ihr Telefon senden
