...
safeb-blocked-phishing-page-learn-more = Tudjon meg többet a megtévesztő oldalakról és az adathalászatról a <a data-l10n-name='learn_more_link'>www.antiphishing.org</a> oldalon. Tudjon meg többet a { -brand-short-name } adathalászat és rosszindulatú szoftver elleni védelméről a <a data-l10n-name='Floorp_support'>support.mozilla.org</a> oldalon.
...
safeb-blocked-malware-page-learn-more-sumo = Tudjon meg többet a { -brand-short-name } adathalászat és rosszindulatú szoftver elleni védelméről a <a data-l10n-name='Floorp_support'>support.mozilla.org</a> oldalon.
...
safeb-blocked-unwanted-page-learn-more = Tudjon meg többet a káros és kéretlen szoftverekről a <a data-l10n-name='learn_more_link'>Kéretlen szoftverekről szóló irányelvekben</a>. Tudjon meg többet a { -brand-short-name } adathalászat és rosszindulatú szoftver elleni védelméről a <a data-l10n-name='Floorp_support'>support.mozilla.org</a> oldalon.
...
safeb-blocked-harmful-page-learn-more = Tudjon meg többet a { -brand-short-name } adathalászat és rosszindulatú szoftver elleni védelméről a <a data-l10n-name='Floorp_support'>support.mozilla.org</a> oldalon.
