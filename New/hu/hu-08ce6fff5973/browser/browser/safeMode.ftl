...
troubleshoot-mode-window =
    .title = Hibaelhárítási módban indítja el a { -brand-short-name }ot?
...
skip-troubleshoot-refresh-profile = Ki is hagyhatja a hibaelhárítást, és fel is frissítheti a { -brand-short-name }ot.
