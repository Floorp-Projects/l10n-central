...
more-from-moz-Floorp-mobile-title = { -brand-product-name } til mobilen
more-from-moz-Floorp-mobile-description = Mobil-browseren, der beskytter dit privatliv.
more-from-moz-Floorp-mobile-description-advanced = { -brand-product-name }-browserne til mobil arbejder på højtryk for at sikre dig en god oplevelse på internettet. Blandt andet blokerer de sporings-mekanismer og sætter en stopper for irriterende videoer, der starter automatisk.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Hent med din mobil-enhed. Peg kameraet på QR-koden og tryk på linket, når det dukker op.
more-from-moz-qr-code-box-Floorp-mobile-button = Send en mail til din telefon i stedet.
