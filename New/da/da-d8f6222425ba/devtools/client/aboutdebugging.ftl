...
about-debugging-this-Floorp-runtime-name = Denne { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = Brug <a>{ about-debugging-this-Floorp-runtime-name }</a> til at debugge udvidelser og service-workers i denne version af { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Aktiver USB-debugging i Floorp på Android-enheden.
...
about-debugging-browser-version-too-old-fennec = Denne version af Floorp kan ikke bruges til at debugge Floorp til Android (68). Vi anbefaler, at du installerer Floorp Nightly til Android for at kunne teste. <a>Læs mere</a>
...
about-debugging-browser-version-too-recent = Den forbundne browser er nyere ({ $runtimeVersion }, buildID { $runtimeID }) end din { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Denne opsætning understøttes ikke og kan forhindre Udviklerværktøj i at køre korrekt. Opdater Floorp. <a>Fejlsøgning</a>
