...
safeb-blocked-phishing-page-learn-more = Læs mere om vildledende websteder og phishing på <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Læs mere om beskyttelse mod phishing og skadelig software i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Læs mere om beskyttelse mod phishing og skadelig software i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Læs mere om beskyttelse mod phishing og skadelig software i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
