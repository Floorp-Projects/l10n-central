...
extension-Floorp-compact-light-description = Tema med lyst farveskema
extension-Floorp-compact-dark-name = Mørkt
extension-Floorp-compact-dark-description = Tema med mørkt farveskema
extension-Floorp-alpenglow-name = Floorp Alpenglow
extension-Floorp-alpenglow-description = Brug et farverigt tema til knapper, menuer og vinduer.
