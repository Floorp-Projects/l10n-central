...
more-from-moz-Floorp-mobile-title = Mobilioji „{ -brand-product-name }“
more-from-moz-Floorp-mobile-description = Naršyklė mobiliesiems, daugiausiai dėmesio skirianti jūsų privatumui.
more-from-moz-Floorp-mobile-description-advanced = Nuo stebėjimo elementų blokavimo iki automatinio grojimo stabdymo – mobiliosios „{ -brand-product-name }“ naršyklės dirba viršvalandžius, siekdamos užtikrinti, kad internetas būtų geras.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Atsisiųskite naudodami savo mobilųjį įrenginį. Nukreipkite kamerą į QR kodą. Kai pasirodys nuoroda, bakstelėkite ją.
more-from-moz-qr-code-box-Floorp-mobile-button = Nusiųsti el. laišką į telefoną
