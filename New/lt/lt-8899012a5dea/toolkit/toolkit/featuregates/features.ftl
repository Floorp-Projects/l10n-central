...
experimental-features-css-cascade-layers-description = Įjungia „CSS Cascade Layers“ palaikymą. Paskaitykite <a data-l10n-name="spec">kuriamą specifikaciją</a> dėl daugiau informacijos. Praneškite apie klaidas, trukdančias <a data-l10n-name="bugzilla">klaidai 1699215</a>, jei randate problemų susijusių su šiuo funkcionalumu.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
