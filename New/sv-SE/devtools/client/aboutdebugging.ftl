...
about-debugging-this-Floorp-runtime-name = Detta { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = Använd <a>{ about-debugging-this-Floorp-runtime-name }</a> för att felsöka tillägg och service workers i den här versionen av { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Aktivera USB-felsökning i Floorp på Android-enheten.
...
about-debugging-browser-version-too-old-fennec = Denna version av Floorp kan inte felsöka Floorp för Android (68). Vi rekommenderar att du installerar Floorp för Android Nightly på din telefon för testning. <a>Mer information</a>
...
about-debugging-browser-version-too-recent = Den anslutna webbläsaren är senare ({ $runtimeVersion }, buildID { $runtimeID }) än ditt { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Det här konfigurationen stöds inte och kan göra att DevTools misslyckas. Vänligen uppdatera Floorp. <a>Felsökning</a>
