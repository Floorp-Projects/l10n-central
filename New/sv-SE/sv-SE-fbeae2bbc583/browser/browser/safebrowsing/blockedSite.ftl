...
safeb-blocked-phishing-page-learn-more = Läs mer om vilseledande webbplatser och nätfiske på <a data-l10n-name='learn_more_link'>www.antiphishing.org</a>. Läs mer om skydd mot nätfiske och skadlig programvara i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-malware-page-learn-more-sumo = Läs mer om { -brand-short-name }’s skydd mot nätfiske och skadlig programvara på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-unwanted-page-learn-more = Läs mer om skadlig och oönskad programvara på <a data-l10n-name='learn_more_link'>Unwanted Software Policy</a>. Läs mer om skydd mot nätfiske och skadlig programvara i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Läs mer om skydd mot nätfiske och skadlig programvara i { -brand-short-name } på <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
