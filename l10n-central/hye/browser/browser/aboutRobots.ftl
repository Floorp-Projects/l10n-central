...
error-title-text = Ողջո՛յն, Մարդիկ։
# Movie: The Day The Earth Stood Still. Spoken by Klaatu.
error-short-desc-text = Մենք եկել ենք այցելութեան խաղաղութեամբ եւ բարեմաղթանքներով։
# Various books by Isaac Asimov. http://en.wikipedia.org/wiki/Three_Laws_of_Robotics
error-long-desc1 = Ռոբոտը չի կարող վնասել մարդուն կամ թոյղ տալ, որ որեւէ մեկը վնասի նրան։
...
error-try-again = Կրկին փորձել
    .label2 = Խնդրում ենք կրկին չսեղմել այս կոճակը։
