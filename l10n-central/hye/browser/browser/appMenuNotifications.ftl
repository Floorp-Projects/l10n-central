...
appmenu-homepage-controlled-changes =
    .label = Ձեր Տնէջը փոխուել է։
    .buttonlabel = Պահպանել փոփոխութիւնները
    .buttonaccesskey = Պ
    .secondarybuttonlabel = Կառավարել Տնէջը
    .secondarybuttonaccesskey = Կ
appmenu-tab-hide-controlled =
    .label = Մուտք գործել Ձեր թաքնուած ներդիրները
    .buttonlabel = Թաքնուած պահել ներդիրները
    .buttonaccesskey = K
