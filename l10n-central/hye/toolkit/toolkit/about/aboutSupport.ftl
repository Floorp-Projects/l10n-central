...
app-basics-distribution-id = Բաշխման նույնականացում
...
has-privileged-user-namespaces = Աւգտագործողի անուանատարածքը արտոնեալ գործընթացքների համար
can-sandbox-content = Բովանդակութեան գործընթաց Sandboxing
