...
about-lepton = 使用 Lepton 自定义 { -brand-short-name }。更改设置后，无需重新启动 { -brand-product-name }，它将自动应用更改。
...
-enable-auto-hide = 启用自动隐藏 $name

floorp-lepton-enable-tab-autohide =
  .label = 启用{ -enable-auto-hide(name 标签栏) }
floorp-lepton-enable-navbar-autohide =
  .label = 启用{ -enable-auto-hide(name 导航栏) }
floorp-lepton-enable-sidebar-autohide =
  .label = 启用{ -enable-auto-hide(name 侧边栏) }
floorp-lepton-enable-urlbar-autohide =
  .label = 启用{ -enable-auto-hide(name 地址栏) }
floorp-lepton-enable-back-button-autohide =
  .label = 启用{ -enable-auto-hide(name  “后退” 按钮) }
floorp-lepton-enable-forward-button-autohide =
  .label = 启用{ -enable-auto-hide(name  “前进” 按钮) }
floorp-lepton-enable-page-action-button-autohide =
  .label = 启用{ -enable-auto-hide(name 地址栏内工具按钮) }
