...
third-party-button-to-unblock-disabled =
    .title = 当前标记为已屏蔽，但此次运行 { -brand-short-name } 时已禁用屏蔽列表。请点击取消屏蔽。
    .aria-label = 当前标记为已屏蔽，但此次运行 { -brand-short-name } 时已禁用屏蔽列表。请点击取消屏蔽。
third-party-button-expand =
    .title = 显示详细信息
third-party-button-collapse =
    .title = 收起详细信息
third-party-requires-restart = { -brand-short-name } 须重启，以生效第三方模块的屏蔽设置。
third-party-should-restart-title = 重启 { -brand-short-name }
third-party-should-restart-ok = 立即重启 { -brand-short-name }
