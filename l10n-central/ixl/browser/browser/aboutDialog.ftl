...
aboutDialog-title =
    .title = Ti' u { -brand-full-name }

releaseNotes-link = Kam ak' at ve'te'
...
aboutdialog-help-user = Lochb'al ta'n { -brand-product-name }
aboutdialog-submit-feedback = Aq'b'en ayol sti'
...
helpus = Nasa' la lochon axh? <label data-l10n-name="helpus-donateLink">Aq'kan umaj akutx</label> moj <label data-l10n-name="helpus-getInvolvedLink">oksa eeb'!</label>
