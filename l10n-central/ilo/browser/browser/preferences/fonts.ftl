...
fonts-langgroup-simpl-chinese =
    .label = Naiyababa nga Insek
fonts-langgroup-trad-chinese-hk =
    .label = Tinawtawid nga Insek (Hong Kong)
fonts-langgroup-trad-chinese =
    .label = Tinawtawid nga Insek (Taiwan)
...
fonts-langgroup-canadian =
    .label = Sangkamaymaysa a Silibario a Kanadiense
fonts-langgroup-other =
    .label = Sabali a Kurditan
