...
options-show-user-agent-styles-tooltip =
    .title = ଏହାକୁ ଅନ୍‌ କଲେ ପୂର୍ବନିର୍ଦ୍ଧାରିତ ଶୈଳୀଗୁଡ଼ିକ ଦୃଶ୍ୟମାନ ହେବ ଯାହାକି ବ୍ରାଉଜର ଦ୍ୱାରା ଧାରଣ କରାଯାଇଥାଏ।

## "Default Color Unit" options for the Inspector

options-default-color-unit-label = ପୂର୍ବନିର୍ଦ୍ଧାରିତ ରଙ୍ଗ ଏକକ (u)
options-default-color-unit-hex = ହେକ୍ସ
...
options-sourceeditor-autoclosebrackets-tooltip =
    .title = ବନ୍ଦହୋଇଥିବା ବନ୍ଧନିଗୁଡ଼ିକୁ ସ୍ୱୟଂଚାଳିତ ଭାବରେ ଭର୍ତ୍ତି କରନ୍ତୁ
options-sourceeditor-autoclosebrackets-label = ସ୍ୱୟଂଚାଳିତ ଭାବରେ ବନ୍ଦ ହେଉଥିବା ବନ୍ଧନିଗୁଡ଼ିକ
options-sourceeditor-expandtab-tooltip =
    .title = ଟ୍ୟାବ ଅକ୍ଷର ପରିବର୍ତ୍ତେ ଖାଲି ସ୍ଥାନ ବ୍ୟବହାର କରନ୍ତୁ
options-sourceeditor-expandtab-label = ଚିହ୍ନ ପାଇଁ ବ୍ୟବହୃତ ସ୍ଥାନ
options-sourceeditor-tabsize-label = ଟାବ ଆକାର
options-sourceeditor-keybinding-label = କି ବନ୍ଧନ
options-sourceeditor-keybinding-default-label = ପୂର୍ବନିର୍ଦ୍ଧାରିତ
...
options-show-platform-data-label = Gecko ପ୍ଲାଟଫର୍ମ ତଥ୍ୟ ଦର୍ଶାନ୍ତୁ
options-show-platform-data-tooltip =
    .title = ଯଦି ଆପଣ ଏହି ବିକଳ୍ପକୁ ସକ୍ରିୟ କରିବେ ତେବେ JavaScript ରୂପରେଖା ବିବରଣୀରେ Gecko ପ୍ଲାଟଫର୍ମ ସଂକେତ ଅନ୍ତର୍ଭୁକ୍ତ ହେବ
