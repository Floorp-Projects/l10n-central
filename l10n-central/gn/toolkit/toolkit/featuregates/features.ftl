...
experimental-features-cookie-samesite-none-requires-secure2-description = Umi kookie “SameSite=none” rekome’ẽ ndive oikotevẽ tekome’ẽ hekorosãva. Ko tembiapoite oikotevẽ “Kookie: SameSite=Lax ijypyguáva”.
