...
experimental-features-css-cascade-layers-description = Activescha il sustegn per CSS Cascade Layers. Vesair la <a data-l10n-name="spec">specificaziun en lavur</a> per detagls. Annunziar sbagls en connex cun questa funcziun sco sbagls che blocheschan il <a data-l10n-name="bugzilla">bug 1699215</a>.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
