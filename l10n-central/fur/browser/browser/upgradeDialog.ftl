...
upgrade-dialog-theme-dark = Scûr
    .title = Dopre un teme scûr pai botons, i menù e i barcons
upgrade-dialog-theme-alpenglow = Alpenglow
    .title = Dopre un teme colorât e dinamic pai botons, i menù e i barcons
upgrade-dialog-theme-keep = Ten il precedent
