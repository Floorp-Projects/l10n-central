...
rights-intro-point-2 = Nejsou vám však podstoupena žádná práva ani licence k ochranným známkám Ablaze & Floorp projects, či třetích stran, a to zejména k logu a názvu Firefox. Podrobnější informace o ochranných známkách jsou dostupné <a data-l10n-name="mozilla-trademarks-link">zde</a>.
