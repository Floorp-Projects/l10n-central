...
compose-send-automatic-description = Если в сообщении не используются стили, отправьте в виде обычного текста. В противном случае отправьте HTML с резервным вариантом в виде обычного текста.
