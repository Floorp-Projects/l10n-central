...
firefoxview-tabpickup-recenttabs-description = Список последних вкладок будет здесь
# Variables:
...
firefoxview-closed-tabs-description = Заново открыть страницы, которые вы закрыли на этом устройстве.
