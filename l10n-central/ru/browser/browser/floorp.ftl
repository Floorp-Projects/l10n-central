...
tab-sleep-timeout-minutes-value = Перевести неактивные вкладки в спящий режим по истечении следующего периода времени (минуты)
...
bookmarks-bar-settings = Настройки панели закладок (не могут быть использованы параллельно)
...
browser-rest-mode =
 .label = Включить горячую клавишу отвечающую за режим отдыха (F9)
...
bsb-width = Ширина (Если этот параметр равен 0, используется глобальное значение)
...
open-profile-dir =
 .label = Открыть папку c текущим профилем
appmenuitem-reboot =
...
how-to-disable-ntbg = Для применения этой настройки необходимо нажать "Ctrl + Shift + R" на стартовой странице { -brand-short-name }.
...
memo-title-input-placeholder = Задайте заголовок здесь
memo-input-placeholder = Напишите или вставте заметку сюда
delete-memo = Удалить
save-memo = Сохранить
...
Gesturefy = Gesturefy
about-Gesturefy = Gesturefy - расширение, которое добавляет использование жестов мыши в ваш браузер. Если { -brand-short-name } обнаружит установку этого дополнения, он добавит в Gesturefy жестовые команды, которые доступны только в { -brand-short-name }.
...
block-fingerprint = Фингерпринтинг - механизм отслеживания, основывающийся на уникальных характеристиках вашего браузера и операционной системы. Этот раздел содержит настройки, позволяющие улучшить защиту от фингерпринтинга.
