...
openInExternal-title = Открыть в стороннем браузере
...
memo-third-tip = Заметки Floorp будут сохранены в настройках Floorp. Кроме того, Firefox Sync шифрует содержимое синхронизации с помощью пароля вашей учетной записи Firefox, поэтому никто, кроме вас, не знает его содержимого.
