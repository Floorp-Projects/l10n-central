...
dns-not-found-with-suggestion = Pretendia aceder a <a data-l10n-name="website">{ $hostAndPath }</a>?
dns-not-found-hint-header = <strong>Se inseriu o endereço correto, pode:</strong>
