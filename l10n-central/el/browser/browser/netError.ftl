...
dns-not-found-with-suggestion = Θέλατε μήπως να μεταβείτε στο <a data-l10n-name="website">{ $hostAndPath }</a>;
dns-not-found-hint-header = <strong>Εάν πληκτρολογήσατε τη σωστή διεύθυνση, μπορείτε να:</strong>
