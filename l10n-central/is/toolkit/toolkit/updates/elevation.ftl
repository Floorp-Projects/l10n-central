...
elevation-details-link-label =
    .value = Nánar
elevation-error-manual = Þú getur uppfært { -brand-short-name } handvirkt með því að opna þessa slóð og hala niður nýjustu útgáfu:
elevation-finished-page = Uppfærsla tilbúin fyrir uppsetningu
elevation-finished-background-page = Búið er að hala niður öryggis- og stöðugleikauppfærslu fyrir { -brand-short-name } og er hún tilbúinn fyrir uppsetningu.
