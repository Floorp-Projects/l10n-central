...
pocket-panel-saved-saving-tags = Сақтау…
...
pocket-panel-signup-already-have = { -pocket-brand-name } пайдаланушысыз ба?
pocket-panel-signup-learn-more = Көбірек білу
pocket-panel-signup-login = Кіру
pocket-panel-signup-signup-email = Эл. поштамен кіру
pocket-panel-signup-signup-cta = { -pocket-brand-name }-те тіркелгіні жасау. Бұл - тегін.
pocket-panel-signup-signup-firefox = { -brand-product-name }-пен тіркелу
