...
dns-not-found-with-suggestion = Ý bạn là truy cập đến trang web <a data-l10n-name="website">{ $hostAndPath }</a>?
dns-not-found-hint-header = <strong>Nếu bạn đã nhập đúng địa chỉ, bạn có thể:</strong>
