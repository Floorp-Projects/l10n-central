...
about-telemetry-page-title = Data ya Telemeta
about-telemetry-histograms-section = Histogramia
about-telemetry-simple-measurements-section = Vipimo Rahisi
about-telemetry-slow-sql-section = Chelewesha Kauli za SQL
...
about-telemetry-slow-sql-main = Kauli za SQL za Kuchelewa kwenye Mtungo Kuu
about-telemetry-slow-sql-other = Kauli za SQL za Kuchelewa kwenye Mtungo za Msaidizi
about-telemetry-slow-sql-hits = Zilizovuma
about-telemetry-slow-sql-average = Saa Wastani (ms)
about-telemetry-slow-sql-statement = Kauli
...
about-telemetry-error-fetching-symbols = Hitilafu lilitokea wakati wa kuchukua ishara. Angalia kwamba umeunganishwa kwa Mtanadao na ujaribu tena.
