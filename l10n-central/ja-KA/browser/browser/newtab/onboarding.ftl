...
mr2-onboarding-colorway-subtitle = 鮮やかで刺激的なテーマコレクション Colorway の新作が期間限定で利用できるで。
mr2-onboarding-colorway-primary-button-label = Colorway を保存するわ
...
mr2-onboarding-theme-tooltip =
    .title = この Colorway を使うで。
# Selector description for non-default colorway theme
# variations e.g. soft, balanced, bold
mr2-onboarding-theme-description =
    .aria-description = この Colorway を使うで。
# Tooltip displayed on hover of colorway
# Variables:
#   $colorwayName (String) - Name of colorway
mr2-onboarding-colorway-tooltip =
    .title = { $colorwayName } の Colorway を使うで。

# Selector description for colorway
# Variables:
#   $colorwayName (String) - Name of colorway
mr2-onboarding-colorway-label = { $colorwayName } の Colorway を見てみいひん?
