...
places-maintenance-button =
    .label = インポートとバックアップ
    .tooltiptext = ブックマークのインポートとバックアップできるで
    .accesskey = I
...
places-import-bookmarks-from-html =
    .label = HTML からインポートするわ
    .accesskey = I
places-export-bookmarks-to-html =
    .label = HTML としてエクスポートするわ
    .accesskey = E
places-import-other-browser =
    .label = 他のブラウザーからデータをインポートするわ
    .accesskey = A
...
places-cmd-find-key =
    .key = f
places-back-button =
    .tooltiptext = フォルダー表示履歴を前に戻るで
places-forward-button =
    .tooltiptext = フォルダー表示履歴を次に進むで
places-details-pane-select-an-item-description = 各項目を選ぶと、名前や詳細情報の表示や編集ができるで
