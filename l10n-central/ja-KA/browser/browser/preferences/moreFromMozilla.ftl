...
about-floorp-description = <label data-l10n-name="floorp-browser-link">{ -brand-product-name }</label> 日本で開発される独立した１つのブラウザーです。Firefox をベースに <label data-l10n-name="ablaze-Link">{ -vendor-short-name }</label> の下で開発されています。協力したいですか？ <label data-l10n-name="helpus-donateLink">寄付</label>をご検討ください！
