...
neterror-dns-not-found-native-fallback-attackers = คุณสามารถดำเนินการต่อด้วยตัวแปลงที่อยู่ DNS ที่ไม่ปลอดภัยได้ อย่างไรก็ตาม บุคคลที่สามอาจสามารถเห็นเว็บไซต์ที่คุณเข้าชม หรือส่งคุณไปยังเว็บไซต์ที่ไม่น่าเชื่อถือได้
neterror-dns-not-found-native-fallback-heuristic = DNS over HTTPS ถูกปิดใช้งานบนเครือข่ายของคุณ
neterror-dns-not-found-native-fallback-not-confirmed = การเชื่อมต่อกับ { $trrDomain } ยังไม่พร้อม
