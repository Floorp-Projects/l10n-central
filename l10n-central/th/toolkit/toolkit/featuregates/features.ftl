...
experimental-features-css-cascade-layers-description = เปิดใช้งานการรองรับ CSS Cascade Layers ดูที่<a data-l10n-name="spec">ข้อมูลจำเพาะที่อยู่ระหว่างดำเนินการ</a>สำหรับรายละเอียด รายงานบั๊กโดยปิดกั้น<a data-l10n-name="bugzilla">บั๊ก 1699215</a> สำหรับบั๊กที่เกี่ยวข้องกับคุณลักษณะนี้
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
