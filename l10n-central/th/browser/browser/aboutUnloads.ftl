...
about-unloads-intro-1 =
    ...
    และแท็บที่จะเลิกโหลดเมื่อมีการทริกเกอร์การเลิกโหลดแท็บ
about-unloads-intro-2 =
    แท็บที่มีอยู่จะถูกแสดงในตารางด้านล่างตามลำดับเดียวกับที่ { -brand-short-name }
    ใช้ในการเลือกแท็บถัดไปที่จะเลิกโหลด ID กระบวนการจะถูกแสดงเป็น<strong>ตัวหนา</strong>
    เมื่อกำลังโฮสต์เฟรมด้านบนของแท็บ และเป็น<em>ตัวเอน</em>เมื่อกระบวนการ
    ถูกแชร์ระหว่างหลายแท็บ คุณสามารถทริกเกอร์การเลิกโหลดแท็บได้ด้วยตนเองโดยคลิก
    ปุ่ม <em>เลิกโหลด</em> ด้านล่าง
about-unloads-intro =
    { -brand-short-name } มีคุณลักษณะที่สามารถเลิกโหลดแท็บโดยอัตโนมัติ
    เพื่อไม่ให้แอปพลิเคชันขัดข้องเมื่อหน่วยความจำที่พร้อมใช้งานของระบบไม่เพียงพอ
    แอปพลิเคชันจะเลือกแท็บถัดไปที่จะเลิกโหลดตามแอตทริบิวต์หลายอย่าง
