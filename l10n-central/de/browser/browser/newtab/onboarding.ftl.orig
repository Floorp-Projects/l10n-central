...
onboarding-live-language-subtitle = { -brand-short-name } ist auf { $appLanguage } eingestellt, dein System jedoch auf { $systemLanguage }.
onboarding-live-language-switch-button-label = Zu { $negotiatedLanguage } wechseln
onboarding-live-language-button-label-downloading = Das Sprachpaket für { $negotiatedLanguage } wird heruntergeladen…
onboarding-live-language-waiting-subtitle = Anscheinend verwenden dein System und { -brand-short-name } unterschiedliche Sprachen.
...
onboarding-live-language-not-now-button-label = Nicht jetzt
