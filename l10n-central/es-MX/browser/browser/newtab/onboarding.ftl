...
onboarding-live-language-subtitle = { -brand-short-name } está usando { $appLanguage } mientras tu sistema está usando { $systemLanguage }.
...
onboarding-live-language-waiting-subtitle = Parece que tu sistema y { -brand-short-name } están usando diferentes idiomas.
