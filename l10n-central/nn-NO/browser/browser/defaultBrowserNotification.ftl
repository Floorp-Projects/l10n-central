...
default-browser-notification-message = <strong>Bruke { -brand-short-name } som standard nettlesar?</strong> Få rask, sikker og privat surfing når du brukar nettet.
