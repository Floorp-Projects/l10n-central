...
experimental-features-cookie-samesite-lax-by-default2-description = Handsam infokapslar som «SameSite=Lax» som standard dersom ingen «SameSite»-attributt er spesifisert. Utviklarar kan framleis velje uavgrensa bruk ved å eksplisitt bruke «SameSite=None».
# Do not translate 'SameSite', 'Lax' and 'None'.
