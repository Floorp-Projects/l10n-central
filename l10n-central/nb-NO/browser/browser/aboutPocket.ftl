...
pocket-panel-signup-already-have = Allerede en { -pocket-brand-name }-bruker?
pocket-panel-signup-learn-more = Les mer
pocket-panel-signup-login = Logg inn
pocket-panel-signup-signup-email = Logg inn med e-postadresse
pocket-panel-signup-signup-cta = Registrer deg for { -pocket-brand-name }. Det er gratis.
...
pocket-panel-home-welcome-back = Velkommen tilbake
pocket-panel-home-paragraph = Du kan bruke { -pocket-brand-name } til å oppdage og lagre nettsider, artikler, videoer, podkaster, eller gå tilbake til det du har lest.
