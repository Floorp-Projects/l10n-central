...
general-legend = Tsebe ya Tshimololo ya { -brand-short-name }

start-page-label =
    .label = Fa { -brand-short-name } e tlhoma, bontsha Tsebe ya Tshimololo mo lefelong la molaetsa
    .accesskey = F
...
restore-default-label =
    .label = Busetsa Thulaganyetso ruri
    .accesskey = B

default-search-engine = Default Search Engine

new-message-arrival = Fa molaetsa o montšhwa o goroga:
mail-play-button =
    .label = Play
    .accesskey = P
...
config-editor-button =
    .label = Motseleganyi wa Thulaganyetso ruri...
    .accesskey = o
...
diskspace-legend = Sebaka sa Disiki
...
display-width-legend = Melaetsa ya Ditlhaka tsa gale Fela

# Note : convert-emoticons-label 'Emoticons' are also known as 'Smileys', e.g. :-)
convert-emoticons-label =
    .label = Bontsha diemotikhone jaaka ditshwantsho
    .accesskey = B

display-text-label = Fa o bontsha melaetsa e e nopotsweng ya Ditlhaka tsa gale Fela:
...
bold-style-item =
    .label = Tlhakakima
italic-style-item =
    .label = Tlhakatshekamo
bold-italic-style-item =
    .label = Tlhakatshekamo e e ntshofaditsweng
...
auto-save-label =
    .label = Boloka ka Itiriso
    .accesskey = l

auto-save-end = metsotso

##

warn-on-send-accel-key =
    .label = Totobatsa fa o dirisa tshelakhutshwane ya khiboto go romela molaetsa
    .accesskey = a

spellcheck-label =
    .label = Tlhola mopeleto pele ga go romela
    .accesskey = T

spellcheck-inline-label =
    .label = Kgontsha mopeleto fa o ntse o tlanya
    .accesskey = E
...
download-dictionaries-link = Kopolola Dibukantswe tse Dingwe
...
ab-label =
    .label = Dibuka tsa Diaterese tsa Selegae
    .accesskey = D

directories-label =
    .label = Dikgatlhong tsa Lenanefaele:
    .accesskey = D
...
edit-directories-label =
    .label = Tseleganya Mananefaele...
    .accesskey = T

email-picker-label =
    .label = Ka boitiriso, ntsenyetse diaterese tsa poso ya eleketoroniki tse di yang ntle:
    .accesskey = i
