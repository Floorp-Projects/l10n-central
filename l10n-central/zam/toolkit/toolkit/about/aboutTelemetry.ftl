...
about-telemetry-choose-ping = B-šèn ping:
about-telemetry-archive-ping-header = Ping
about-telemetry-page-title = Dízh na Telemetry
about-telemetry-general-data-section = Chó kúe
about-telemetry-session-info-section = Cho thus kuey
...
about-telemetry-events-section = Ní
...
about-telemetry-slow-sql-hits = Besta
...
about-telemetry-category-header = pá sóy
about-telemetry-method-header = xá lí men ná
