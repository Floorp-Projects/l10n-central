...
import-paragraph = { -brand-short-name } vám umožní importovať emailové správy, položky adresára, odoberané informačné kanály, nastavenia a/alebo filtre z iných poštových klientov a z bežných formátov adresárov.
