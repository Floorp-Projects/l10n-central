...
dns-not-found-with-suggestion = Menade du att gå till <a data-l10n-name="website">{ $hostAndPath }</a>?
dns-not-found-hint-header = <strong>Om du har angett rätt adress kan du:</strong>
