...
task-due-label =
    .value = 締切日時:
edit-intab-label =
    .label = 予定と ToDo をダイアログウィンドウやなくてタブで編集しとく
    .accesskey = t
prompt-delete-label =
    .label = 予定や ToDo を消す前に確認しとく
    .accesskey = V
accessibility-legend = アクセシビリティ
accessibility-colors-label =
    .label = システムの配色に最適化しとく
    .accesskey = c
...
reminder-dialog-label =
    .label = アラームボックスを表示しとく
    .accesskey = x
missed-reminder-label =
    .label = 書き込み可能カレンダーの見逃したアラームを表示しとく
    .accesskey = m
...
task-alarm-time-label =
    ...
    .accesskey = o
calendar-notifications-customize-label = 通知はカレンダーのプロパティウィンドウでカレンダーごとにカスタマイズできるで。
category-new-label = 新しいカテゴリー
category-edit-label = カテゴリーの編集
category-overwrite-title = 警告: 重複した名前
category-overwrite = そのカテゴリー名はすでにあるで。\n上書きしてもええか？
category-blank-warning = カテゴリー名を入力してや。
