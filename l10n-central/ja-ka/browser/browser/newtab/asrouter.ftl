...
cfr-doorhanger-extension-notification2 = おすすめ
  .tooltiptext = おすすめの拡張機能やで
  .a11y-announcement = おすすめの拡張機能があるで

# This is a notification displayed in the address bar.
# When clicked it opens a panel with a message for the user.
cfr-doorhanger-feature-notification = おすすめ
  .tooltiptext = おすすめの機能やで
  .a11y-announcement = おすすめの機能があるで
...
cfr-doorhanger-bookmark-fxa-header = どこからせやけどブックマークを同期しまっせ。
cfr-doorhanger-bookmark-fxa-body = 見つかっちゃった。ブックマークをこの端末だけに残しておかんと同期してくれ。{ -fxaccount-brand-name } を始めましょう。
...
cfr-protections-panel-body = あんたのデータはあんた自身だけに。{ -brand-short-name } はオンラインでのあんたの行動を追跡するよく知られたぎょうさんのトラッカーからあんたを守りまっせ。
...
cfr-doorhanger-doh-header = 暗号化 DNS でより安全にするで
...
cfr-doorhanger-fission-primary-button = OK、有効にするで
  .accesskey = O
...
cfr-doorhanger-video-support-body = このバージョンの { -brand-short-name } では、このサイトの動画を正しく再生できまへん。今すぐ、動画に完全対応しとる { -brand-short-name } に更新しいや。
cfr-doorhanger-video-support-header = { -brand-short-name } を更新して動画を再生
cfr-doorhanger-video-support-primary-button = 今すぐ更新する
  .accesskey = U

## Spotlight modal shared strings

spotlight-learn-more-collapsed = 詳細
  .title = 展開してこの機能の詳細を見るわ
...
spotlight-public-wifi-vpn-body = あんたの行動と訪問先を秘匿すんなら、VPN  自分の行動と訪問先を秘匿すんなら、VPN を検討してみい。空港や喫茶店のような公共の場所でブラウジングするときのプライバシーを保護しまっせ。
...
spotlight-total-cookie-protection-body = 包括的 Cookie 保護機能は Cookie を利用して自分を追跡するトラッカーを遮断してくれるで。 これまでにない最も強力なプライバシー保護機能を試してみいひん?
# "Early access" for this feature rollout means it's a "feature preview" or
# "soft launch" as not everybody will get it yet.
spotlight-total-cookie-protection-expanded = 自分が訪問したサイト上でトラッカーが追跡できひんように { -brand-short-name } が Cookie の周りにフェンスを建てて制限しまっせ。早期アクセスに参加すると、この機能が最適化され、すべての人にとってのよりよいウェブを構築し続ける助けになるねん。
