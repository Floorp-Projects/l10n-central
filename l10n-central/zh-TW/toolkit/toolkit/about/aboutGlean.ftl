...
about-glean-description = Ablaze 在產品中使用 <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> 來收集資料。此頁面是用來給開發者與測試者<a data-l10n-name="fog-debug-doc-link">調整 Glean SDK 的除錯與紀錄狀態</a>使用。
