...
elevation-more-elevated =
    આ અપડેટ માટે વ્યવસ્થાપક વિશેષાધિકારો આવશ્યક છે. આ અપડેટ
    આગલી વખતે { -brand-short-name } શરૂ થાય પછી ઇન્સ્ટોલ થશે. છે તમે ફરીથી પ્રારંભ કરી શકો છો
    { -brand-short-name } હવે, કામ ચાલુ રાખો અને પછીથી ફરી શરૂ કરો, અથવા આ નકારો
    અપડેટ કરો.
