...
account-otr-description = { -brand-short-name } supporta le cryptation de un extremo al altere del conversationes un-a-un. Isto impedi al tertie partes de spiar un conversation. Le cryptation de un extremo al altere pote solo esser usate quando le altere persona alsi usa software que supporta le OTR.
