...
pocket-panel-signup-already-have = Al in { -pocket-brand-name }-brûker?
pocket-panel-signup-learn-more = Mear ynfo
pocket-panel-signup-login = Meld jo oan
pocket-panel-signup-signup-email = Registrearje mei e-mailadres
pocket-panel-signup-signup-cta = Registrearje foar { -pocket-brand-name }. It is fergees.
