...
lost = <b>Jo binne gjin persoanlike gegevens of oanpassingen kwytrekke.</b> As jo al ynformaasje yn Firefox op dizze kompjûter bewarre hawwe, is dizze noch hieltyd yn in oare ynstallaasje fan Firefox beskikber.
...
sync-terms = Troch fierder te gean, geane jo akkoard mei de <a data-l10n-name="terms">Tsjinstbetingsten</a> en <a data-l10n-name="privacy">Privacyferklearring</a>.
