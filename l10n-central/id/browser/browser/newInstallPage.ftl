...
lost = <b>Anda belum kehilangan data pribadi ata penyesuaian.</b> Jika Anda telah menyimpan informasi ke Firefox pada komputer ini, informasi tersebut masih tersedia pada pemasangan Firefox lainnya.
...
sync-terms = Dengan melanjutkan, berarti Anda setuju dengan <a data-l10n-name="terms">Ketentuan Layanan</a> dan <a data-l10n-name="privacy">Pernyataan Privasi</a>.
