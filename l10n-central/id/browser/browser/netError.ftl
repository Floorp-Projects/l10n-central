...
dns-not-found-with-suggestion = Apakah Anda bermaksud membuka <a data-l10n-name="website">{ $hostAndPath }</a>?
dns-not-found-hint-header = <strong>Jika Anda memasukkan alamat yang benar, Anda dapat:</strong>
