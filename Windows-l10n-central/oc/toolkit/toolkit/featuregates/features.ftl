...
experimental-features-win32k-lockdown =
    .label = Embarrament de Win32k
experimental-features-win32k-lockdown-description = Desactiva l’utilizacion de  las API de Win32k dins los onglets del navegador. Provesís un creis de la seguretat mas es instable actualament o problematic. (Sonque per Windows)
# JS JIT Warp project
