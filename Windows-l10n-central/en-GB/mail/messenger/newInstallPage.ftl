...
lost = <b>You have not lost any personal data or customisations.</b> If you’ve already saved information to { -brand-product-name } on this computer, it is still available in another { -brand-product-name } installation.
