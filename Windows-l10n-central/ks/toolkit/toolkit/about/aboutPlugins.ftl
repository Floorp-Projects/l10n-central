...
path-dd = <span data-l10n-name="path">وَتھ:</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">ورجن</span> { $version }
...
state-dd-enabled = <span data-l10n-name="state">سیٹیٹ:</span> قابل مجازكرمت
