...
crashed-multiple-offer-help-message = Kies { crashed-restore-tab-button } of { crashed-restore-all-button } om de pagina/pagina’s opnieuw te laden.
...
crashed-include-URL-2 = De URL’s bijvoegen van de websites die u bezocht toen { -brand-short-name } crashte
