...
app-basics-update-channel = ຊ່ອງທາງອັບເດດ
app-basics-update-history = ປະຫວັດການອັບເດດ
app-basics-show-update-history = ສະແດງປະຫວັດການອັບເດດ
...
app-basics-memory-use = ກາານໃຊ້ຫນ່ວຍຄວາມຈຳ
app-basics-performance = ປະສິດທິພາບ
...
library-version-title = ລຸ້ນ Library
