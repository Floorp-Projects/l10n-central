...
proxyConnectFailure-title = Միջնորդ սպասարկիչն մերժէ զկապակցմունս
proxyResolveFailure-title = Չէ հնար գտանել զմիջնորդ սպասարկչ
redirectLoop-title = Այս էջ ոչ վերուղղորդէ պատշաճաբար
...
clockSkewError-title = Ժամացոյց համակարգչի քոյ սխալ է։
