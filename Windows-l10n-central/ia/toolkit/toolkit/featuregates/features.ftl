...
experimental-features-css-cascade-layers-description = Activa supporto pro CSS Cascade Layers. Consultar le <a data-l10n-name="spec">specificas (in laboration)</a> pro detalios. Pro problemas causate per questa function, aperir un bug blocante le <a data-l10n-name="bugzilla">bug 1699215</a>.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
