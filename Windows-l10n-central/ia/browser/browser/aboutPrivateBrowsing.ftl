...
about-private-browsing-info-description-private-window = Fenestra anonyme: { -brand-short-name } clara tu chronologia de recerca e navigation quando tu claude tote le fenestras anonyme. Isto non te rende anonyme.
