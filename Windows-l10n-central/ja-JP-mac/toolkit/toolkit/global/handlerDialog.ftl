...
chooser-dialog-description = { $scheme } リンクを開くアプリケーションを選択してください。
# Please keep the emphasis around the scheme (ie the `<strong>` HTML tags).
chooser-dialog-remember = 常にこのアプリケーションで <strong>{ $scheme }</strong> リンクを開く
...
choose-app-btn =
    .label = 選択...
    .accessKey = C
choose-other-app-window-title = 別のアプリケーション...
# Displayed under the name of a protocol handler in the Launch Application dialog.
choose-dialog-privatebrowsing-disabled = プライベートウインドウで無効化されます
