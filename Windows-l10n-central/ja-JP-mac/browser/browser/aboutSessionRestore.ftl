...
restore-page-window-label = ウインドウ { $windowNumber }
...
welcome-back-restore-button =
    .label = 復元
    .accesskey = L
welcome-back-restore-all-label = ウインドウとタブをすべて復元する
welcome-back-restore-some-label = 復元するウインドウとタブを選択する
welcome-back-page-info-link = アドオンとカスタマイズした設定を削除しました。ブラウザー設定をデフォルトに戻しました。それでも問題が解決しない場合は、<a data-l10n-name="link-more">ヘルプをご覧ください。</a>
