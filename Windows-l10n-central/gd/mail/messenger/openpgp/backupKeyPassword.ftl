...
set-password-backup-pw =
    .value = Facal-faire an lethbhric-ghlèidhidh air an iuchair dhìomhair:

set-password-repeat-backup-pw =
    .value = Facal-faire an lethbhric-ghlèidhidh air an iuchair dhìomhair (a-rithist):

set-password-reminder = <b>Cudromach</b>: ma dhìochuimhnicheas tu facal-faire lethbhreac-glèidhidh na h-iuchrach dìomhair agad, chan urrainn dhut an lethbhreac-glèidhidh seo a chleachdadh às dèidh sin. Cùm cunntas dheth ann an àite sàbhailte.
