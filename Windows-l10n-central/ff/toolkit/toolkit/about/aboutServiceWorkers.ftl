...
about-service-workers-title = Baɗte Gollooɓe Sarwiis
...
scope = <strong>Hewto:</strong> { $name }
script-spec = <strong>Dokkorol Spec:</strong> <a data-l10n-name="link">{ $url }</a>
current-worker-url = <strong>URL mo Golloowe Gonaaɗo:</strong> <a data-l10n-name="link">{ $url }</a>
active-cache-name = <strong>Innde Kaasol Caasngol:</strong> { $name }
