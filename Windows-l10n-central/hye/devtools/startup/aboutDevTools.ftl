...
enable-about-debugging-message = Մշակէք եւ վրիպազերծէք WebExtensions-ը, ցանցային աշխատողները, ծառայութեան աշխատողները եւ աւելին` Firefox-ի մշակող գործիքների հետ:
...
features-responsive-desc = Փորձարկել կայքերը Ձեր դիտարկիչում նմանեցուած սարքերի վրայ։ <a data-l10n-name="learn-more">{ features-learn-more }</a>
