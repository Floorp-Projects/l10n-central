...
file-dd = <span data-l10n-name="file">Lopk:</span> { $pluginLibraries }
path-dd = <span data-l10n-name="path">Stegna:</span> { $pluginFullPath }
version-dd = <span data-l10n-name="version">Wersjô:</span> { $version }
...
state-dd-enabled = <span data-l10n-name="state">Stón:</span> Włączoné
