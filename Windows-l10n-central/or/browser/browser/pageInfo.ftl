...
security-tab =
    ...
    .accesskey = S
security-view =
    .label = ପ୍ରମାଣ ପତ୍ର ଦେଖନ୍ତୁ
    .accesskey = V
security-view-unknown = ଅଜଣା
    .value = ଅଜଣା
...
not-set-date = ଉଲ୍ଲେଖିତ ହୋଇନଥିବା
media-img = ପ୍ରତିଛବି
media-bg-img = ପୃଷ୍ଠଭୂମି
media-border-img = ଧାର
media-list-img = ବିନ୍ଦୁ
media-cursor = ସୂଚକ
media-object = ବସ୍ତୁ
media-embed = ଅନ୍ତଃ ସ୍ଥାପିତ
media-link = ଚିତ୍ରସଙ୍କେତ
media-input = ନିବେଶ
media-video = ଭିଡିଓ
media-audio = ଧ୍ୱନି
