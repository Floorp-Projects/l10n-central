...
import-paragraph = { -brand-short-name } дає змогу імпортувати електронні листи, записи адресних книг, підписки на стрічки, налаштування або/та фільтри з інших поштових програм та поширених форматів адресних книг.
