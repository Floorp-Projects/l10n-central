...
about-private-browsing-info-description-private-window = Приватне вікно: { -brand-short-name } очищує історію пошуку та перегляду, коли ви закриваєте усі приватні вікна. Це не робить вас анонімними.
