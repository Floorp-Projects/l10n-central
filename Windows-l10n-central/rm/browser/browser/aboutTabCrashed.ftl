...
crashed-include-URL-2 = Integrar ils URLs da las paginas avertas cura che { -brand-short-name } è collabà
...
crashed-auto-submit-checkbox-2 = Actualisar las preferenzas per trametter automaticamain rapports sche { -brand-short-name } collabescha
