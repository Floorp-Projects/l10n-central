...
restore-page-tab-title = Natee sesión
...
restore-page-list-header =
    .label = Ventanas ji pestañas

restore-page-try-again-button =
    .label = Natee tuku sesión
    .accesskey = R

restore-page-close-button =
    .label = Kajie´e sesión jíía
    .accesskey = N

## The following strings are used in about:welcomeback

welcome-back-tab-title = Nkunei!
welcome-back-page-title = Nkuneí!
welcome-back-page-info = { -brand-short-name } kuvi kaka inka nuu.
