...
enable-about-debugging-message = Desarrolar ji depurar WebExtensions, Web Workers, service workers ji kue'e ji ka̱a̱ desarrollador Firefox.
enable-key-shortcut-message = Nteenu iin atajo da ka̱a̱ desarrollador. De iin error nkuvi, kuvi nakasɨnɨ pestaña ya'a.
enable-menu-message = Sa'a vii HTML, CSS ji JavaScript nuu web noo'o ji ka̱a̱ kua inspector ji depurador.
enable-common-message = Da ka̱a̱ desarrollador íyo na'va sa kuvi tetiñu va'a ka̱a̱ nánuku.
