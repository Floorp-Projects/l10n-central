...
account-otr-description = { -brand-short-name } admite el cifrado de extremo a extremo en conversaciones uno a uno. Esto evita que terceros escuchen a escondidas una conversación. El cifrado de extremo a extremo solo se puede usar cuando la otra persona también usa software que admite OTR.
