...
media-location =
    .value = സ്ഥാനം:
media-text =
    .value = സംബന്ധിച്ചുള്ള വാചകം:
media-alt-header =
    .label = പകരം ടെക്സ്റ്റ്‌
media-address =
    .label = വിലാസം
media-type =
    .label = ഏതു് തരം
...
security-tab =
    ...
    .accesskey = S
security-view =
    .label = സര്‍ട്ടിഫിക്കേറ്റ് കാണുക
    .accesskey = V
security-view-unknown = അപരിചിതം
    .value = അപരിചിതം
security-view-identity =
    .value = വെബ് സൈറ്റ് തിരിച്ചറിയല്‍
...
not-set-date = വ്യക്തമാക്കിയിട്ടില്ല
media-img = ചിത്രം
