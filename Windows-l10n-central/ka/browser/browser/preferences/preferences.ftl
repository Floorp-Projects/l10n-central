...
browsing-media-control =
    .label = მართეთ ფაილები კლავიატურით, ყურსასმენით ან პროგრამული არედან
    .accesskey = ფ
...
sync-signedout-description2 = დაასინქრონეთ თქვენი სანიშნეები, ისტორია, ჩანართები, პაროლები, დამატებები და პარამეტრები ყველა მოწყობილობაზე.
...
sitedata-option-block-cross-site-tracking-cookies-including-social-media =
    .label = საიტთაშორისი მეთვალყურე ფუნთუშები — მოიცავს სოც. ქსელებისასაც
sitedata-option-block-cross-site-cookies-including-social-media =
    .label = საიტთაშორისი ფუნთუშები — მოიცავს სოც. ქსელებისასაც
