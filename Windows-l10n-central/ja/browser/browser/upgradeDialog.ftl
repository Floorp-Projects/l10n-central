...
upgrade-dialog-colorway-default-theme = 既定
# "Auto" is short for "Automatic"
upgrade-dialog-colorway-theme-auto = 自動
    .title = ボタンやメニュー、ウィンドウについてオペレーティングシステムの設定に従います
...
upgrade-dialog-thankyou-subtitle = { -brand-short-name } は、{ -vendor-short-name } 製品群の高速なブラウザーです。プライバシーを保護し、ウェブをより健全にしていきます。
