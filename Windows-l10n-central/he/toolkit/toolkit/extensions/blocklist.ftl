...
blocklist-soft-and-hard = התוספות שמהוות סיכון גבוה ליצירת בעיות יציבות ואבטחה נחסמו. התוספות האחרות מהוות סיכון נמוך יותר, אבל מומלץ להפעיל מחדש את התוכנה כשהן מנוטרלות.
