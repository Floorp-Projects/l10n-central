...
experimental-features-css-cascade-layers =
    .label = CSS: podpora Cascade Layers
experimental-features-css-cascade-layers-description = Zapne podporu pre CSS Cascade Layers. Podrobnosti nájdete v <a data-l10n-name="spec">tvoriacej sa špecifikácii</a>. Objavené chyby hláste v bugzille, každú nastavte ako blocker pre <a data-l10n-name="bugzilla">bug 1699215</a>.
# The title of the experiment should be kept in English as it may be referenced
# by various online articles and is technical in nature.
