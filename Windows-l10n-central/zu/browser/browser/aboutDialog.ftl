...
community-2 = I-{ -brand-short-name } yenzwe ngu- <label data-l10n-name="community-mozillaLink">I-{ -vendor-short-name }</label>, a <label data-l10n-name="community-creditsLink">umphakathi womhlaba</label> ukusebenza ngokubambisana ukugcina iwebhu ivulekile, ingeyomphakathi futhi ifinyeleleka kuwonke wonke.
