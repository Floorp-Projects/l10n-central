...
elevation-details-link-label =
    .value = Detaloj
elevation-error-manual = Vi povas ĝisdatigi { -brand-short-name } mem. Vizitu tiun ĉi ligilon kaj elŝutu la lastan version:
elevation-finished-page = Preta instali ĝisdatigon
elevation-finished-background-page =
    Sekureca kaj stabileca ĝisdatigo por { -brand-short-name } estis
