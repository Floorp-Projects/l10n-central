...
pocket-panel-saved-saving-tags = Konservo…
...
pocket-panel-signup-already-have = Ĉu vi jam estas uzanto de { -pocket-brand-name }?
pocket-panel-signup-learn-more = Pli da informo
pocket-panel-signup-login = Komenci seancon
pocket-panel-signup-signup-email = Enskribiĝi per retpoŝto
pocket-panel-signup-signup-cta = Enskribiĝi al { -pocket-brand-name }. Estas senpage.
pocket-panel-signup-signup-firefox = Enskribiĝi per { -brand-product-name }
