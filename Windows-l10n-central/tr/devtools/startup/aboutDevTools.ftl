...
features-console-desc = CSS, JavaScript, güvenlik ve ağ sorunlarını takip edin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-debugger-title = Hata ayıklayıcı
features-debugger-desc = Kullandığınız framework’ü destekleyen, güçlü JavaScript hata ayıklayıcısı. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-network-title = Ağ
features-network-desc = Sitenizi yavaşlatan veya kilitleyen ağ isteklerini denetleyin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-storage-title = Depolama
features-storage-desc = Önbellek, çerez, veritabanı ve oturum verilerini ekleyin, düzenleyin ve silin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-responsive-title = Responsive Tasarım Modu
features-responsive-desc = Sitelerin başka cihazlarda nasıl görüneceğini tarayıcının içinde test edin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-visual-editing-title = Görsel Düzenleme
features-visual-editing-desc = Animasyonları, hizalamayı ve padding’i görerek düzenleyin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
features-performance-title = Performans
features-performance-desc = Tıkanmaların önüne geçin, işlemleri izleyin, varlıkları optimize edin. <a data-l10n-name="learn-more">{ features-learn-more }</a>
