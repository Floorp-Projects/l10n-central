...
pocket-panel-signup-already-have = Sêstu za un utent di { -pocket-brand-name }?
pocket-panel-signup-learn-more = Plui informazions
pocket-panel-signup-login = Jentre
pocket-panel-signup-signup-email = Regjistriti cu la e-mail
pocket-panel-signup-signup-cta = Regjistriti in { -pocket-brand-name }. Al è gratuit.
pocket-panel-signup-signup-firefox = Regjistriti cun { -brand-product-name }
