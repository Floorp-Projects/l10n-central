...
appmenu-update-available-message2 = Prenesite najnovejšo različico { -brand-shorter-name(sklon: "rodilnik") }.
...
appmenu-update-unsupported-message2 = Vaš operacijski sistem ni združljiv z najnovejšo različico { -brand-shorter-name(sklon: "rodilnik") }.
...
appmenu-homepage-controlled-changes =
    .label = Domača stran se je spremenila.
    .buttonlabel = Obdrži spremembe
    .buttonaccesskey = O
    .secondarybuttonlabel = Nastavitve domače strani
    .secondarybuttonaccesskey = N
