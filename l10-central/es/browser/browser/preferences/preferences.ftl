...
home-mode-choice-default =
    .label = Inicio de Floorp (Predeterminado)
...
home-prefs-content-header = Contenido de la página de inicio de Floorp
home-prefs-content-description = Selecciona el contenido que desea en la pantalla de inicio de Floorp.
...
sync-mobile-promo = Descargar Floorp para <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> para sincronizar con tu dispositivo móvil.
...
sync-engine-addons =
    .label = Complementos
    .tooltiptext = Extensiones y temas para Floorp para escritorio
    .accesskey = C
