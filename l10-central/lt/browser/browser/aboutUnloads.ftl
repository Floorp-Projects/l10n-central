...
about-unloads-intro-1 =
    ...
    užmigdytos suveikus šiai funkcijai.
about-unloads-intro-2 =
    Esamos kortelės yra rodomos žemiau esančioje lentelėje tokia tvarka, kokia
    „{ -brand-short-name }“ jas užmigdytų. Procesų ID yra <strong>paryškinti</strong>,
    kai juose veikia kortelės pagrindinis kadras, ir rodomi <em>kursyvu</em>,
    kai procesu dalinasi kelios kortelės. Korteles užmigdyti galite ir patys,
