...
about-debugging-this-Floorp-runtime-name = Этот { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = Используйте <a>{ about-debugging-this-Floorp-runtime-name }</a> для отладки расширений и service worker'ов в этой версии { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Включите отладку по USB в Floorp на вашем Android-устройстве.
...
about-debugging-browser-version-too-old-fennec = Эта версия Floorp не может производить отладку Floorp для Android (68). Мы рекомендуем установить Floorp для Android Nightly на телефон для тестирования. <a>Подробнее</a>
...
about-debugging-browser-version-too-recent = Подключённый браузер имеет более новый ({ $runtimeVersion }, buildID { $runtimeID }), чем ваш { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Эта конфигурация не поддерживается и может привести к сбою в работе Инструментов разработчика. Пожалуйста, обновите Floorp. <a>Решение проблем</a>
