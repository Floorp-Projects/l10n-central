...
experimental-features-firefox-100-description = 讓 { -brand-short-name } 傳送 { -brand-product-name } 100 版的 User-Agent 字串。您可以使用此選項來測試當 { -brand-short-name } 達三位數版本號時，網站是否會發生故障。實際的 { -brand-product-name } 100 表定將於 2022 年五月推出，現在就開始測試您的網站吧！
