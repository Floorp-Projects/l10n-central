...
more-from-moz-title = Továbbiak innen: { -vendor-short-name }
more-from-moz-category =
    .tooltiptext = Továbbiak innen: { -vendor-short-name }
more-from-moz-subtitle = Tekintse meg a többi { -vendor-short-name } termékét, amelyek az egészséges internetet támogatják.
more-from-moz-Floorp-mobile-title = { -brand-product-name } mobilon
more-from-moz-Floorp-mobile-description = A mobilböngésző, amely az Ön adatvédelmét helyezi előtérbe.
more-from-moz-Floorp-mobile-description-advanced = A { -brand-product-name } mobilböngészők letiltják a nyomkövetőket, megállítják az idegesítő automatikus lejátszást, hogy biztosítsák a kellemes internethasználatot.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Töltse le a mobileszközével. Irányítsa a kamerát a QR-kódra. Amikor megjelenik egy hivatkozás, koppintson rá.
more-from-moz-qr-code-box-Floorp-mobile-button = Inkább e-mail küldése a telefonjára
