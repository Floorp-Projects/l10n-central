...
enable-title = Floorp fejlesztői eszközök engedélyezése
enable-inspect-element-title = A Floorp fejlesztői eszközök használhatják a Vizsgáló elemet
enable-inspect-element-message = Vizsgálja meg és szerkessze a HTML-t és CSS-t a fejlesztői eszközök vizsgálójával.
enable-about-debugging-message = Fejlesszen WebExtensionöket, web workereket, service workereket és másokat a Floorp fejlesztői eszközeivel.
...
enable-common-message = A Floorp fejlesztői eszközök alapértelmezett le vannak tiltva, hogy jobb irányítással rendelkezzen a böngészője felett.
...
welcome-title = Üdvözöljük a Floorp fejlesztői eszközökben!
...
footer-message = Többre vágyik a fejlesztői eszközöknél? Nézze meg a Floorp böngészőt, amely kifejezetten a fejlesztőknek, és modern munkamenetekhez készül.
