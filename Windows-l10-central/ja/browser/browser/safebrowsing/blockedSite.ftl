...
safeb-blocked-phishing-page-learn-more = 詐欺サイトとフィッシング詐欺についての詳細は、<a data-l10n-name='learn_more_link'>www.antiphishing.org</a> をご覧ください。{ -brand-short-name } のフィッシング詐欺とマルウェアからの保護機能についての詳細は、<a data-l10n-name='Floorp_support'>support.mozilla.org</a> をご覧ください。
safeb-blocked-malware-page-error-desc-override-sumo = <span data-l10n-name='sitename'>{ $sitename }</span> は、<a data-l10n-name='error_desc_link'>悪意のあるソフトウェアを配布するサイトとして報告されています</a>。<a data-l10n-name='ignore_warning_link'>危険性を無視</a> して、この安全でないサイトを訪れることができます。
safeb-blocked-malware-page-error-desc-no-override-sumo = <span data-l10n-name='sitename'>{ $sitename }</span> は、<a data-l10n-name='error_desc_link'>悪意のあるソフトウェアを配布するサイトとして報告されています</a>。
safeb-blocked-malware-page-learn-more-sumo = { -brand-short-name } の偽装サイトとマルウェアからの防護機能の詳細は、<a data-l10n-name='Floorp_support'>support.mozilla.org</a> をご覧ください。
...
safeb-blocked-unwanted-page-learn-more = 有害な望ましくないソフトウェアについての詳細は、<a data-l10n-name='learn_more_link'>望ましくないソフトウェアのポリシー</a> をご覧ください。{ -brand-short-name } のフィッシング詐欺とマルウェアからの保護機能についての詳細は、<a data-l10n-name='Floorp_support'>support.mozilla.org</a> をご覧ください。
...
safeb-blocked-harmful-page-learn-more = { -brand-short-name } のフィッシング詐欺とマルウェアからの保護機能についての詳細は、<a data-l10n-name='Floorp_support'>support.mozilla.org</a> をご覧ください。
