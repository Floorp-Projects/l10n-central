...
more-from-moz-mozilla-vpn-description = 匿名でのブラウジングと保護を強化します。日本ではご利用になれません。
more-from-moz-mozilla-vpn-description-advanced = { -mozilla-vpn-brand-name } は、匿名でのブラウジングと保護をもう一段強化します。そして、他のVPNとは異なり、安全で、あなたの活動を追跡することはありません。

# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-title = { -rally-brand-name }
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description = より良いインターネットを実現するために、あなたのデータを活用しませんか？
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-mozilla-rally-description-advanced = あなたのデータを、より安全でオープンなインターネットを実現するための調査研究に寄付してください。
# This string is specific to the product Mozilla Rally which is US only.
more-from-moz-button-mozilla-rally =
  .label = { -rally-short-name } に参加

more-from-moz-qr-code-box-firefox-mobile-title = モバイル端末に Firefox をダウンロードするには、QRコードにカメラを向けてください。リンクが表示されたら、タップしてください。
more-from-moz-qr-code-box-firefox-mobile-button = 代わりに、スマートフォンに通知を送信しますか？

more-from-moz-button-mozilla-vpn =
  .label = VPN を取得

more-from-moz-learn-more-link = 詳細はこちら