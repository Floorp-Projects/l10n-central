...
enable-title = Floorp 開発ツールを有効にする
enable-inspect-element-title = Floorp 開発ツールを有効にして、要素を調査する
enable-inspect-element-message = 開発ツールの要素調査機能で HTML と CSS の調査や編集ができます。
enable-about-debugging-message = Floorp 開発ツールで、ブラウザー拡張機能や Web Worker、Service Worker を開発、デバッグできます。
...
enable-common-message = ブラウザをより詳細にコントロールできる Floorp 開発ツールは既定の設定では無効になっています。
enable-learn-more-link = 開発ツールの詳細
enable-enable-button = Floorp 開発ツールを有効にする
enable-close-button = このタブを閉じる
welcome-title = Floorp 開発ツールにようこそ！
...
footer-message = 単なる開発ツール以上のものをお探しですか？ 開発者と新しい作業フローのために特別にビルドされた Floorp をお試しください。
