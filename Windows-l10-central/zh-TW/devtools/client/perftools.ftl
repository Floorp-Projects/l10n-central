...
perftools-intro-description = 記錄過程將在新分頁開啟 profiler.Floorp.com。所有資料都儲存在您的本機上，但您可以決定是否要上傳分享。
...
perftools-description-intro = 記錄過程將在新分頁開啟 <a>profiler.Floorp.com</a>。所有資料都儲存在您的本機上，但您可以決定是否要上傳分享。
...
perftools-presets-Floorp-platform-description = 推薦於 Floorp 內部平台除錯時使用。
perftools-presets-Floorp-front-end-label = Floorp 前端
perftools-presets-Floorp-front-end-description = 推薦於 Floorp 內部前端介面除錯時使用。
perftools-presets-Floorp-graphics-label = Floorp 圖形
perftools-presets-Floorp-graphics-description = 推薦於檢查 Floorp 圖形效能問題時使用。
perftools-presets-Floorp-label = { -brand-shorter-name }
perftools-presets-Floorp-description = 對 { -brand-shorter-name } 進行效能檢測的建議預設值。
...
perftools-presets-media-description = 推薦於診斷 Floorp 影音問題時使用。
