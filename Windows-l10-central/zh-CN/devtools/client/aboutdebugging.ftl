...
about-debugging-this-Floorp-runtime-name = 此 { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = 使用<a>{ about-debugging-this-Floorp-runtime-name }</a> 调试此版本 { -brand-shorter-name } 上的扩展和 Service Worker。
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = 在 Android 设备的 Floorp 中启用“USB 调试”功能。
# USB section step by step guide
...
about-debugging-browser-version-too-old-fennec = Floorp 无法调试 Android 版 Floorp（68）。我们建议您在手机上安装 Android 版 Floorp Nightly 进行测试。<a>更多信息</a>
...
about-debugging-browser-version-too-recent =
    已连接的浏览器（版本 { $runtimeVersion }、buildID { $runtimeID }）比您的 { -brand-shorter-name }（{ $localVersion }、buildID { $localID }）还新。这个不受支持的设置可能导致开发者工具故障。请更新 Floorp。
    <a>故障排除</a>
