...
enable-title = Ativar ferramentas de desenvolvimento do Floorp
enable-inspect-element-title = Ative as ferramentas de desenvolvimento do Floorp para usar o Inspect Element
enable-inspect-element-message = Examine e edite HTML e CSS com o Inspetor das ferramentas de desenvolvimento.
enable-about-debugging-message = Desenvolva e depure WebExtensions, web workers, service workers e muito mais com as ferramentas de desenvolvimento do Floorp.
...
enable-common-message = As ferramentas de desenvolvimento do Floorp são desativadas por padrão para dar a você mais controle sobre seu navegador.
...
welcome-title = Boas-vindas às ferramentas de desenvolvimento do Floorp!
...
footer-message = Procurando mais do que as ferramentas de desenvolvimento? Confira o navegador Floorp que é construído especificamente para desenvolvedores e fluxos de trabalho modernos.
