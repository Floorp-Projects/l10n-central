...
enable-title = Habilitar herramientas de desarrollo de Floorp
enable-inspect-element-title = Habilite las herramientas de desarrollo de Floorp para usar Inspeccionar elemento
enable-inspect-element-message = Examine y edite HTML y CSS con el Inspector de las herramientas de desarrollo.
enable-about-debugging-message = Desarrolle y depure WebExtensions, web workers, service workers y más con las herramientas para desarrolladores de Floorp.
...
enable-common-message = Las herramientas para desarrolladores de Floorp están desactivadas por defecto para darle más control sobre su navegador.
...
welcome-title = ¡Bienvenido a las herramientas para desarrolladores de Floorp!
...
footer-message = ¿Busca algo más que unas simples herramientas para desarrolladores? Revise el navegador Floorp creado específicamente para desarrolladores y flujos de desarrollo modernos.
