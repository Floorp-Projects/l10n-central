...
safeb-blocked-phishing-page-learn-more = Consultez <a data-l10n-name='learn_more_link'>www.antiphishing.org</a> pour en savoir plus sur les sites trompeurs et l’hameçonnage. Consultez <a data-l10n-name='Floorp_support'>support.mozilla.org</a> pour en savoir plus sur le système de protection de { -brand-short-name } contre l’hameçonnage et les logiciels malveillants.
...
safeb-blocked-malware-page-learn-more-sumo = Pour en savoir plus sur le système de protection contre l’hameçonnage et les logiciels malveillants de { -brand-short-name } vous pouvez consulter <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Pour en savoir plus sur le système de protection contre l’hameçonnage et les logiciels malveillants de { -brand-short-name } vous pouvez consulter <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
