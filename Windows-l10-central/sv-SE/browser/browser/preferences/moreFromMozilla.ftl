...
more-from-moz-Floorp-mobile-title = { -brand-product-name } för mobil
more-from-moz-Floorp-mobile-description = Den mobila webbläsaren som sätter din integritet främst.
more-from-moz-Floorp-mobile-description-advanced = Från att blockera spårare till att stoppa irriterande innehåll med automatisk uppspelning, { -brand-product-name } mobila webbläsare arbetar övertid för att säkerställa att du får bästa möjliga surfning på internet.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Ladda ner med din mobila enhet. Rikta kameran mot QR-koden. När en länk visas trycker du på den.
more-from-moz-qr-code-box-Floorp-mobile-button = Skicka ett mejl till din telefon istället
