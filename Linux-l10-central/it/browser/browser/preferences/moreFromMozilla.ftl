...
more-from-moz-Floorp-mobile-title = { -brand-product-name } per dispositivi mobili
more-from-moz-Floorp-mobile-description = Il browser per dispositivi mobili che mette la tua privacy al primo posto.
more-from-moz-Floorp-mobile-description-advanced = Dal blocco degli elementi traccianti allo stop dei fastidiosi contenuti con riproduzione automatica, i browser mobili della famiglia { -brand-product-name } fanno gli straordinari per garantirti la migliore navigazione possibile su Internet.
...
more-from-moz-button-mozilla-rally =
  .label = Partecipa a { -rally-short-name }

more-from-moz-qr-code-box-Floorp-mobile-title = Scarica utilizzando un dispositivo mobile. Punta la tua fotocamera al codice QR e tocca il link quando viene visualizzato.
more-from-moz-qr-code-box-Floorp-mobile-button = Oppure invia un’email al tuo telefono
