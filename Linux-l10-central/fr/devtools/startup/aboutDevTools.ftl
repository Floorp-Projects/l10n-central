...
enable-title = Activer les outils de développement de Floorp
enable-inspect-element-title = Activez les outils de développement de Floorp pour utiliser Examiner l’élément
...
enable-about-debugging-message = Développez et déboguez des WebExtensions, des web workers, des service workers et bien plus grâce aux outils de développement de Floorp.
...
enable-common-message = Les outils de développement de Floorp sont désactivés par défaut afin de vous permettre de contrôler davantage votre navigateur.
...
welcome-title = Bienvenue dans les outils de développement de Floorp !
...
footer-message = Vous recherchez davantage que des outils de développement ? Découvrez le navigateur Floorp conçu spécifiquement pour les développeurs et les flux de travail modernes.
