...
about-debugging-this-Floorp-runtime-name = Ce { -brand-shorter-name }
...
about-debugging-setup-this-Floorp2 = Utilisez <a>{ about-debugging-this-Floorp-runtime-name }</a> pour déboguer des extensions et service workers sur cette version de { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Activez le débogage USB dans Floorp sur l’appareil Android.
...
about-debugging-browser-version-too-old-fennec = Cette version de Floorp ne peut pas déboguer Floorp pour Android (68). Nous vous recommandons d’installer Floorp pour Android Nightly sur votre téléphone pour les tests. <a>Plus de détails</a>
