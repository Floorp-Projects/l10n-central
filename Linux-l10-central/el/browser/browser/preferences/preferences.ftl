...
home-mode-choice-default =
    .label = Αρχική σελίδα Floorp (Προεπιλογή)
...
home-prefs-content-header = Περιεχόμενο αρχικής σελίδας Floorp
home-prefs-content-description = Επιλέξτε τι περιεχόμενο θέλετε στην αρχική σελίδα του Floorp σας.
home-prefs-search-header =
    .label = Διαδικτυακή αναζήτηση
home-prefs-topsites-header =
    .label = Κορυφαίοι ιστότοποι
home-prefs-topsites-description = Οι ιστότοποι που επισκέπτεστε περισσότερο
home-prefs-topsites-by-option-sponsored =
    .label = Χορηγούμενοι κορυφαίοι ιστότοποι
...
home-prefs-highlights-description = Μια συλλογή ιστοτόπων από τους σελιδοδείκτες ή το ιστορικό
...
sync-mobile-promo = Κάντε λήψη του Floorp για <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> ή <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> για συγχρονισμό με την κινητή σας συσκευή.
...
sync-engine-addons =
    .label = Πρόσθετα
    .tooltiptext = Επεκτάσεις και θέματα για το Floorp για υπολογιστές
    .accesskey = Π
