...
screenshots-connection-error-title = Мы не можем получить доступ к вашим скриншотам.
...
screenshots-unshootable-page-error-details = Так как это не обычная веб-страница, мы не можем сделать её скриншот.
