...
fxa-qrcode-heading-step1 = 1. Jei to dar nepadarėte, įdiekite <a data-l10n-name="connect-another-device">„Floorp“ savo mobiliajame įrenginyje</a>.

fxa-qrcode-heading-step2 = 2. Atverkite „Floorp“  savo mobiliajame įrenginyje.
