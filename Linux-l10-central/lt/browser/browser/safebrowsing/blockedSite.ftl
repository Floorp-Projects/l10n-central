...
safeb-blocked-malware-page-learn-more-sumo = Sužinokite daugiau apie „{ -brand-short-name }“ apsaugą nuo sukčiavimo ir kenkėjiškų programų apsilankę <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Sužinokite daugiau apie „{ -brand-short-name }“ apsaugą nuo sukčiavimo ir kenkėjiškų programų apsilankę <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
