...
more-from-moz-Floorp-mobile-title = { -brand-product-name } para dispositivos móveis
more-from-moz-Floorp-mobile-description = O navegador para dispositivos móveis que coloca sua privacidade em primeiro lugar.
more-from-moz-Floorp-mobile-description-advanced = De bloquear rastreadores a frear aborrecimentos de reprodução automática, os navegadores { -brand-product-name } para dispositivos móveis realizam trabalho adicional para assegurar que você tenha uma boa internet.
...
more-from-moz-qr-code-box-Floorp-mobile-title = Baixe usando seu dispositivo móvel. Aponte a câmera para o código QR e toque no link que irá aparecer.
more-from-moz-qr-code-box-Floorp-mobile-button = Em vez disso, envie um email para seu celular
