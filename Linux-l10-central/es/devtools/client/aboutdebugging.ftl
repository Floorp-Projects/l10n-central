...
about-debugging-setup-this-Floorp2 = Usa <a>{ about-debugging-this-Floorp-runtime-name }</a> para depurar extensiones y service workers en esta versión de { -brand-shorter-name }.
...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-Floorp2 = Habilitar depuración USB en Floorp en el dispositivo Android.
...
about-debugging-browser-version-too-old-fennec = Esta versión de Floorp no puede depurar Floorp para Android (68). Recomendamos instalar Floorp para Android Nightly en tu teléfono para realizar pruebas. <a>Más detalles</a>
