...
safeb-blocked-malware-page-learn-more-sumo = Aprenda más sobre la protección contra malware y phishing de { -brand-short-name } en <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
...
safeb-blocked-harmful-page-learn-more = Más información sobre la protección contra phishing y software malicioso de { -brand-short-name } en <a data-l10n-name='Floorp_support'>support.mozilla.org</a>.
